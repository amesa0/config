...
/** @constructor */
function $c_Lbiz_enef_angulate_Angular$() {
  $c_O.call(this)
}
$c_Lbiz_enef_angulate_Angular$.prototype = new $h_O();
$c_Lbiz_enef_angulate_Angular$.prototype.constructor = $c_Lbiz_enef_angulate_Angular$;
/** @constructor */
function $h_Lbiz_enef_angulate_Angular$() {
  /*<skip>*/
}
$h_Lbiz_enef_angulate_Angular$.prototype = $c_Lbiz_enef_angulate_Angular$.prototype;
$c_Lbiz_enef_angulate_Angular$.prototype.init___ = (function() {
  return this
});
$c_Lbiz_enef_angulate_Angular$.prototype.apply__Lbiz_enef_angulate_Angular = (function() {
  var $$this = $g.angular;
  if (($$this === (void 0))) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(new $c_jl_RuntimeException().init___T("Could not find object angular - has the Angular.js library been loaded?"))
  } else {
    return $$this
  }
});
var $d_Lbiz_enef_angulate_Angular$ = new $TypeData().initClass({
  Lbiz_enef_angulate_Angular$: 0
}, false, "biz.enef.angulate.Angular$", {
  Lbiz_enef_angulate_Angular$: 1,
  O: 1
});
$c_Lbiz_enef_angulate_Angular$.prototype.$classData = $d_Lbiz_enef_angulate_Angular$;
var $n_Lbiz_enef_angulate_Angular$ = (void 0);
function $m_Lbiz_enef_angulate_Angular$() {
  if ((!$n_Lbiz_enef_angulate_Angular$)) {
    $n_Lbiz_enef_angulate_Angular$ = new $c_Lbiz_enef_angulate_Angular$().init___()
  };
  return $n_Lbiz_enef_angulate_Angular$
}
/** @constructor */
function $c_Lbiz_enef_angulate_ext_Route$() {
  $c_O.call(this)
}
$c_Lbiz_enef_angulate_ext_Route$.prototype = new $h_O();
$c_Lbiz_enef_angulate_ext_Route$.prototype.constructor = $c_Lbiz_enef_angulate_ext_Route$;
/** @constructor */
function $h_Lbiz_enef_angulate_ext_Route$() {
  /*<skip>*/
}
$h_Lbiz_enef_angulate_ext_Route$.prototype = $c_Lbiz_enef_angulate_ext_Route$.prototype;
$c_Lbiz_enef_angulate_ext_Route$.prototype.init___ = (function() {
  return this
});
$c_Lbiz_enef_angulate_ext_Route$.prototype.apply__T__sjs_js_Function__T__sjs_js_Dictionary__T__sjs_js_Function3__T__sjs_js_Function1__T__sjs_js_Function1__Lbiz_enef_angulate_ext_Route = (function(controller, controllerFn, controllerAs, resolve, redirectTo, redirectToFn, template, templateFn, templateUrl, templateUrlFn) {
  var r = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary($m_sci_Nil$());
  if ((controller !== null)) {
    r.controller = controller
  };
  if ((controllerFn !== null)) {
    r.controller = controllerFn
  };
  if ((controllerAs !== null)) {
    r.controllerAs = controllerAs
  };
  if ((resolve !== null)) {
    r.resolve = resolve
  };
  ...
  if ((redirectToFn !== null)) {
    r.redirectTo = redirectToFn
  };
  if ((template !== null)) {
    r.template = template
  };
  if ((templateFn !== null)) {
    r.template = templateFn
  };
  if ((templateUrl !== null)) {
    r.templateUrl = templateUrl
  };
  if ((templateUrlFn !== null)) {
    r.templateUrl = templateUrlFn
  };
  return r
});
var $d_Lbiz_enef_angulate_ext_Route$ = new $TypeData().initClass({
  Lbiz_enef_angulate_ext_Route$: 0
}, false, "biz.enef.angulate.ext.Route$", {
  Lbiz_enef_angulate_ext_Route$: 1,
  O: 1
});
$c_Lbiz_enef_angulate_ext_Route$.prototype.$classData = $d_Lbiz_enef_angulate_ext_Route$;
var $n_Lbiz_enef_angulate_ext_Route$ = (void 0);
function $m_Lbiz_enef_angulate_ext_Route$() {
  if ((!$n_Lbiz_enef_angulate_ext_Route$)) {
    $n_Lbiz_enef_angulate_ext_Route$ = new $c_Lbiz_enef_angulate_ext_Route$().init___()
  };
  return $n_Lbiz_enef_angulate_ext_Route$
}
/** @constructor */
function $c_Lbiz_enef_angulate_package$() {
  $c_O.call(this);
  this.angular$1 = null
}
$c_Lbiz_enef_angulate_package$.prototype = new $h_O();
$c_Lbiz_enef_angulate_package$.prototype.constructor = $c_Lbiz_enef_angulate_package$;
/** @constructor */
function $h_Lbiz_enef_angulate_package$() {
  /*<skip>*/
}
$h_Lbiz_enef_angulate_package$.prototype = $c_Lbiz_enef_angulate_package$.prototype;
$c_Lbiz_enef_angulate_package$.prototype.init___ = (function() {
  $n_Lbiz_enef_angulate_package$ = this;
  this.angular$1 = $m_Lbiz_enef_angulate_Angular$().apply__Lbiz_enef_angulate_Angular();
  return this
});
var $d_Lbiz_enef_angulate_package$ = new $TypeData().initClass({
  Lbiz_enef_angulate_package$: 0
}, false, "biz.enef.angulate.package$", {
  Lbiz_enef_angulate_package$: 1,
  O: 1
});
$c_Lbiz_enef_angulate_package$.prototype.$classData = $d_Lbiz_enef_angulate_package$;
var $n_Lbiz_enef_angulate_package$ = (void 0);
function $m_Lbiz_enef_angulate_package$() {
  if ((!$n_Lbiz_enef_angulate_package$)) {
    $n_Lbiz_enef_angulate_package$ = new $c_Lbiz_enef_angulate_package$().init___()
  };
  return $n_Lbiz_enef_angulate_package$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_Routes$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_Routes$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_Routes$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_Routes$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_Routes$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_Routes$.prototype = $c_Lco_ledger_wallet_web_ethereum_Routes$.prototype;
$c_Lco_ledger_wallet_web_ethereum_Routes$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_Routes$.prototype.declare__Lbiz_enef_angulate_ext_RouteProvider__Lbiz_enef_angulate_ext_RouteProvider = (function($$routeProvider) {
  return $$routeProvider.when("/onboarding/live", $m_Lbiz_enef_angulate_ext_Route$().apply__T__sjs_js_Function__T__sjs_js_Dictionary__T__sjs_js_Function3__T__sjs_js_Function1__T__sjs_js_Function1__Lbiz_enef_angulate_ext_Route(null, null, null, null, null, null, null, null, "./templates/onboarding/go_live.html", null)).otherwise($m_Lbiz_enef_angulate_ext_Route$().apply__T__sjs_js_Function__T__sjs_js_Dictionary__T__sjs_js_Function3__T__sjs_js_Function1__T__sjs_js_Function1__Lbiz_enef_angulate_ext_Route(null, null, null, null, "/onboarding/live", null, null, null, null, null))
});
var $d_Lco_ledger_wallet_web_ethereum_Routes$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_Routes$: 0
}, false, "co.ledger.wallet.web.ethereum.Routes$", {
  Lco_ledger_wallet_web_ethereum_Routes$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_Routes$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_Routes$;
var $n_Lco_ledger_wallet_web_ethereum_Routes$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_Routes$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_Routes$)) {
    $n_Lco_ledger_wallet_web_ethereum_Routes$ = new $c_Lco_ledger_wallet_web_ethereum_Routes$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_Routes$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$.prototype = $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("actionsBottomBar", [(function(f) {
    return (function() {
      return f.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$: 0
}, false, "co.ledger.wallet.web.ethereum.components.ActionsBottomBar$", {
  Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$;
var $n_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$ = new $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_LButton() {
  $c_O.call(this);
  this.text$1 = null;
  this.icon$1 = null;
  this.type$1 = null;
  this.$$unddisabled$1 = false
}
$c_Lco_ledger_wallet_web_ethereum_components_LButton.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_LButton.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_LButton;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_LButton() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_LButton.prototype = $c_Lco_ledger_wallet_web_ethereum_components_LButton.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_LButton.prototype.init___ = (function() {
  this.text$1 = "";
  this.icon$1 = "";
  this.type$1 = "validate";
  this.$$unddisabled$1 = false;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_LButton.prototype.disabled$und$eq__T__V = (function(v) {
  var this$2 = new $c_sci_StringOps().init___T(v);
  this.$$unddisabled$1 = $s_sci_StringLike$class__parseBoolean__p0__sci_StringLike__T__Z(this$2, this$2.repr$1)
});
var $d_Lco_ledger_wallet_web_ethereum_components_LButton = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_LButton: 0
}, false, "co.ledger.wallet.web.ethereum.components.LButton", {
  Lco_ledger_wallet_web_ethereum_components_LButton: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_LButton.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_LButton;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_LButton$() {
  $c_O.call(this)
}
...
$c_Lco_ledger_wallet_web_ethereum_components_LButton$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("lbutton", (function() {
    var jsx$4 = $m_sjs_js_Dictionary$();
    var y = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("icon", "@"), new $c_T2().init___O__O("text", "@"), new $c_T2().init___O__O("type", "@"), new $c_T2().init___O__O("disabled", "@"), new $c_T2().init___O__O("href", "@"), new $c_T2().init___O__O("small", "@")]));
    var jsx$3 = new $c_T2().init___O__O("scope", y);
    var jsx$2 = new $c_T2().init___O__O("templateUrl", null);
    var jsx$1 = new $c_T2().init___O__O("controller", "co.ledger.wallet.web.ethereum.components.LButton");
    ...
    var y$1 = $s_sci_StringLike$class__stripMargin__sci_StringLike__C__T(this$21, 124);
    return jsx$4.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3, jsx$2, jsx$1, new $c_T2().init___O__O("template", y$1), new $c_T2().init___O__O("restrict", "E")]))
  })).controller("co.ledger.wallet.web.ethereum.components.LButton", ["$scope", (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_LButton$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_LButton$: 0
}, false, "co.ledger.wallet.web.ethereum.components.LButton$", {
...
$c_Lco_ledger_wallet_web_ethereum_components_LButton$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_LButton$;
var $n_Lco_ledger_wallet_web_ethereum_components_LButton$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_LButton$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_LButton$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_LButton$ = new $c_Lco_ledger_wallet_web_ethereum_components_LButton$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_LButton$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_NavigationBar$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_NavigationBar$.prototype = $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("navigationBar", ["$location", "$route", (function(f) {
    return (function(arg1, arg2) {
      return f.apply__O__O__O(arg1, arg2)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_NavigationBar$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_NavigationBar$: 0
}, false, "co.ledger.wallet.web.ethereum.components.NavigationBar$", {
  Lco_ledger_wallet_web_ethereum_components_NavigationBar$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_NavigationBar$;
var $n_Lco_ledger_wallet_web_ethereum_components_NavigationBar$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_NavigationBar$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_NavigationBar$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_NavigationBar$ = new $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_NavigationBar$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar() {
  $c_O.call(this);
  this.width$1 = 0;
  this.animated$1 = false;
  this.$$undtotal$1 = 0;
  this.$$undprogress$1 = 0
}
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_ProgressBar() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_ProgressBar.prototype = $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar.prototype.init___ = (function() {
  this.width$1 = 300;
...
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar.prototype.percent__I = (function() {
  var a = (($imul(100, this.$$undprogress$1) / this.$$undtotal$1) | 0);
  return ((a < 100) ? a : 100)
});
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar.prototype.percent$und$eq__T__V = (function(percent) {
  this.$$undtotal$1 = 100;
  var this$2 = new $c_sci_StringOps().init___T(percent);
  var this$4 = $m_jl_Integer$();
  var s = this$2.repr$1;
  this.$$undprogress$1 = this$4.parseInt__T__I__I(s, 10)
});
var $d_Lco_ledger_wallet_web_ethereum_components_ProgressBar = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_ProgressBar: 0
}, false, "co.ledger.wallet.web.ethereum.components.ProgressBar", {
  Lco_ledger_wallet_web_ethereum_components_ProgressBar: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_ProgressBar;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$() {
  $c_O.call(this)
}
...
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("progressbar", (function() {
    var jsx$4 = $m_sjs_js_Dictionary$();
    var y = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("progress", "@"), new $c_T2().init___O__O("total", "@"), new $c_T2().init___O__O("percent", "@"), new $c_T2().init___O__O("width", "@"), new $c_T2().init___O__O("animated", "@")]));
    var jsx$3 = new $c_T2().init___O__O("scope", y);
    var jsx$2 = new $c_T2().init___O__O("templateUrl", null);
    var jsx$1 = new $c_T2().init___O__O("controller", "co.ledger.wallet.web.ethereum.components.ProgressBar");
    var this$19 = new $c_sci_StringOps().init___T("\n      |<div class=\"progressbar\" >\n      | <div style=\"width: {{width}}px\">\n      |   <div class=\"left\" style=\"width: {{percent}}%\" ng-class=\"{animated: animated}\"></div>\n      | </div>\n      | <div class=\"regular-text-small\">{{percent}}%</div>\n      |</div>\n    ");
    var y$1 = $s_sci_StringLike$class__stripMargin__sci_StringLike__C__T(this$19, 124);
    return jsx$4.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3, jsx$2, jsx$1, new $c_T2().init___O__O("template", y$1), new $c_T2().init___O__O("restrict", "E")]))
  })).controller("co.ledger.wallet.web.ethereum.components.ProgressBar", ["$scope", (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_ProgressBar$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_ProgressBar$: 0
}, false, "co.ledger.wallet.web.ethereum.components.ProgressBar$", {
...
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_ProgressBar$;
var $n_Lco_ledger_wallet_web_ethereum_components_ProgressBar$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_ProgressBar$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_ProgressBar$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_ProgressBar$ = new $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_ProgressBar$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$.prototype = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("qrcodescanner", [(function(f) {
    return (function() {
      return f.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$: 0
}, false, "co.ledger.wallet.web.ethereum.components.QrCodeScanner$", {
  Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$;
var $n_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$ = new $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$.prototype = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("qrcodeviewer", [(function(f) {
    return (function() {
      return f.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$: 0
}, false, "co.ledger.wallet.web.ethereum.components.QrCodeViewer$", {
  Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$;
var $n_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$ = new $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton() {
  $c_O.call(this);
  this.$$undrunning$1 = false
}
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_RefreshButton() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_RefreshButton.prototype = $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton.prototype.init___ = (function() {
  this.$$undrunning$1 = false;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton.prototype.running$und$eq__T__V = (function(v) {
  var this$2 = new $c_sci_StringOps().init___T(v);
  this.$$undrunning$1 = $s_sci_StringLike$class__parseBoolean__p0__sci_StringLike__T__Z(this$2, this$2.repr$1)
});
var $d_Lco_ledger_wallet_web_ethereum_components_RefreshButton = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_RefreshButton: 0
}, false, "co.ledger.wallet.web.ethereum.components.RefreshButton", {
  Lco_ledger_wallet_web_ethereum_components_RefreshButton: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_RefreshButton;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$() {
  $c_O.call(this)
}
...
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("refreshbutton", (function() {
    var jsx$1 = $m_sjs_js_Dictionary$();
    var y = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("running", "@")]));
    return jsx$1.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("scope", y), new $c_T2().init___O__O("templateUrl", null), new $c_T2().init___O__O("controller", "co.ledger.wallet.web.ethereum.components.RefreshButton"), new $c_T2().init___O__O("template", "<img class=\"refresh-button\" ng-class=\"{spinning: running}\" src=\"images/refresh_button/ic_green_refresh.png\"/>"), new $c_T2().init___O__O("restrict", "E")]))
  })).controller("co.ledger.wallet.web.ethereum.components.RefreshButton", ["$scope", (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_RefreshButton$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_RefreshButton$: 0
}, false, "co.ledger.wallet.web.ethereum.components.RefreshButton$", {
...
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_RefreshButton$;
var $n_Lco_ledger_wallet_web_ethereum_components_RefreshButton$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_RefreshButton$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_RefreshButton$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_RefreshButton$ = new $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_RefreshButton$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_Selector() {
  $c_O.call(this);
  this.$$scope$1 = null;
  this.$$undselected$1 = null;
  this.$$undonSelectionChanged$1 = null;
  this.$$undvalues$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_Selector;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_Selector() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_Selector.prototype = $c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype.values$und$eq__sjs_js_Dictionary__V = (function(v) {
  this.$$undvalues$1 = $g.JSON.parse(v);
  if ((this.$$undselected$1 === null)) {
    var dict = this.$$undvalues$1;
    var this$4 = new $c_sjs_js_WrappedDictionary$DictionaryIterator().init___sjs_js_Dictionary(dict);
    this.$$undselected$1 = $as_T(this$4.next__T2().$$und1__O())
  }
});
$c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype.init___Lbiz_enef_angulate_Scope = (function($$scope) {
  this.$$scope$1 = $$scope;
  this.$$undselected$1 = null;
  this.$$undonSelectionChanged$1 = null;
  this.$$undvalues$1 = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary($m_sci_Nil$());
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype.changed$und$eq__T__V = (function(fun) {
  var x = $objectGetClass(fun);
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  this.$$undonSelectionChanged$1 = fun
});
$c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype.isSelected__T__Z = (function(key) {
  return (this.$$undselected$1 === key)
});
$c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype.select__T__O = (function(key) {
  this.$$undselected$1 = key;
  if ((this.$$undonSelectionChanged$1 !== null)) {
    var jsx$1 = this.$$scope$1.$parent;
    var s = this.$$undonSelectionChanged$1;
    return jsx$1.$eval(s, {
      "value": key
    })
  } else {
...
var $d_Lco_ledger_wallet_web_ethereum_components_Selector = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_Selector: 0
}, false, "co.ledger.wallet.web.ethereum.components.Selector", {
  Lco_ledger_wallet_web_ethereum_components_Selector: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_Selector.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_Selector;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_Selector$() {
  $c_O.call(this)
}
...
$h_Lco_ledger_wallet_web_ethereum_components_Selector$.prototype = $c_Lco_ledger_wallet_web_ethereum_components_Selector$.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_Selector$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_Selector$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("selector", (function() {
    var jsx$1 = $m_sjs_js_Dictionary$();
    var y = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("values", "@"), new $c_T2().init___O__O("selected", "@"), new $c_T2().init___O__O("changed", "@")]));
    return jsx$1.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("scope", y), new $c_T2().init___O__O("templateUrl", "templates/components/selector.html"), new $c_T2().init___O__O("controller", "co.ledger.wallet.web.ethereum.components.Selector"), new $c_T2().init___O__O("template", null), new $c_T2().init___O__O("restrict", "E")]))
  })).controller("co.ledger.wallet.web.ethereum.components.Selector", ["$scope", "$scope", (function(f) {
    return (function(arg1, arg2) {
      return f.apply__O__O__O(arg1, arg2)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_Selector$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_Selector$: 0
}, false, "co.ledger.wallet.web.ethereum.components.Selector$", {
...
$c_Lco_ledger_wallet_web_ethereum_components_Selector$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_Selector$;
var $n_Lco_ledger_wallet_web_ethereum_components_Selector$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_Selector$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_Selector$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_Selector$ = new $c_Lco_ledger_wallet_web_ethereum_components_Selector$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_Selector$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$() {
  $c_O.call(this);
  this.SuccessMode$1 = 0;
  this.ErrorMode$1 = 0;
  this.NeutralMode$1 = 0
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$.prototype.init___ = (function() {
  this.SuccessMode$1 = 0;
  this.ErrorMode$1 = 1;
  this.NeutralMode$1 = 2;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("snackbar", ["$translate", (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$;
var $n_Lco_ledger_wallet_web_ethereum_components_SnackBar$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_SnackBar$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_SnackBar$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_SnackBar$ = new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_SnackBar$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance() {
  $c_O.call(this);
  this.snackBar$1 = null;
  this.dismissHandler$1 = null;
  this.$$undmode$1 = 0;
  this.$$undtitle$1 = null;
  this.$$undsubtitle$1 = null;
  this.$$unddelay$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype.subtitle__T__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance = (function(subtitle) {
  this.$$undsubtitle$1 = subtitle;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar = (function(snackBar) {
  this.snackBar$1 = snackBar;
  this.dismissHandler$1 = null;
  this.$$undmode$1 = 0;
  this.$$undtitle$1 = "";
  this.$$undsubtitle$1 = "";
  var this$2 = new $c_s_concurrent_duration_package$DurationInt().init___I(3);
  var unit = $m_ju_concurrent_TimeUnit$().SECONDS$1;
  this.$$unddelay$1 = $m_s_concurrent_duration_package$DurationInt$().durationIn$extension__I__ju_concurrent_TimeUnit__s_concurrent_duration_FiniteDuration(this$2.scala$concurrent$duration$DurationInt$$n$1, unit);
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype.title__T__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance = (function(title) {
  this.$$undtitle$1 = title;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype.mode__I__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance = (function(mode) {
  this.$$undmode$1 = mode;
  return this
});
function $is_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance)))
}
function $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(obj) {
  return (($is_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "co.ledger.wallet.web.ethereum.components.SnackBar$SnackBarInstance"))
}
function $isArrayOf_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance)))
}
function $asArrayOf_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(obj, depth) {
  return (($isArrayOf_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lco.ledger.wallet.web.ethereum.components.SnackBar$SnackBarInstance;", depth))
}
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$SnackBarInstance", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_Spinner$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_Spinner$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_Spinner$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_Spinner$.prototype = $c_Lco_ledger_wallet_web_ethereum_components_Spinner$.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.directive("spinner", ["$parse", (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_components_Spinner$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_Spinner$: 0
}, false, "co.ledger.wallet.web.ethereum.components.Spinner$", {
  Lco_ledger_wallet_web_ethereum_components_Spinner$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_Spinner$;
var $n_Lco_ledger_wallet_web_ethereum_components_Spinner$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_components_Spinner$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_components_Spinner$)) {
    $n_Lco_ledger_wallet_web_ethereum_components_Spinner$ = new $c_Lco_ledger_wallet_web_ethereum_components_Spinner$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_components_Spinner$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_controllers_WindowController$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_controllers_WindowController$.prototype = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$.prototype;
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.controller("WindowController", ["windowService", "$scope", "$element", "$document", (function(f) {
    return (function(arg1, arg2, arg3, arg4) {
      return f.apply__sjs_js_Dynamic__Lco_ledger_wallet_web_ethereum_services_WindowService__Lbiz_enef_angulate_Scope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_JQLite__sjs_js_Dynamic(this, $as_Lco_ledger_wallet_web_ethereum_services_WindowService(arg1), arg2, arg3, arg4)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_controllers_WindowController$: 0
}, false, "co.ledger.wallet.web.ethereum.controllers.WindowController$", {
  Lco_ledger_wallet_web_ethereum_controllers_WindowController$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController$;
var $n_Lco_ledger_wallet_web_ethereum_controllers_WindowController$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_controllers_WindowController$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_controllers_WindowController$)) {
    $n_Lco_ledger_wallet_web_ethereum_controllers_WindowController$ = new $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_controllers_WindowController$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$.prototype = $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$.prototype;
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.controller("LedgerLiveController", ["windowService", "$scope", "$route", "$location", "$routeParams", (function(f) {
    return (function(arg1, arg2, arg3, arg4, arg5) {
      return f.apply__sjs_js_Dynamic__Lco_ledger_wallet_web_ethereum_services_WindowService__Lbiz_enef_angulate_Scope__sjs_js_Dynamic__Lbiz_enef_angulate_core_Location__sjs_js_Dictionary__sjs_js_Dynamic(this, $as_Lco_ledger_wallet_web_ethereum_services_WindowService(arg1), arg2, arg3, arg4, arg5)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1().init___())])
});
var $d_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$: 0
}, false, "co.ledger.wallet.web.ethereum.controllers.onboarding.LedgerLiveController$", {
  Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$;
var $n_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$)) {
    $n_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$ = new $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$.prototype = $c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$.prototype;
$c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$.prototype.injectCustomEasings__V = (function() {
  $g.$.easing["default"] = (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(this.defaultEasing__p1__F1())
});
$c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$.prototype.defaultEasing__p1__F1 = (function() {
  return new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(p$2) {
    var p = $uD(p$2);
    var a = (1.0 - p);
    return (1 - $uD($g.Math.pow(a, 6.0)))
  }))
});
var $d_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$: 0
}, false, "co.ledger.wallet.web.ethereum.core.utils.JQueryHelper$", {
  Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$;
var $n_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$)) {
    $n_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$ = new $c_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$.prototype = $c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$.prototype;
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  var filterFactory = ["$translate", "$q", (function(f) {
    return (function(arg1, arg2) {
      return f.apply__O__O__O(arg1, arg2)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1().init___())];
  return module.filter("date", filterFactory)
});
var $d_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$: 0
}, false, "co.ledger.wallet.web.ethereum.filters.DateFormatFilter$", {
  Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$;
var $n_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$)) {
    $n_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$ = new $c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_i18n_I18n$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_i18n_I18n$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_i18n_I18n$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_i18n_I18n$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_i18n_I18n$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_i18n_I18n$.prototype = $c_Lco_ledger_wallet_web_ethereum_i18n_I18n$.prototype;
$c_Lco_ledger_wallet_web_ethereum_i18n_I18n$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18n$.prototype.init__Lco_ledger_wallet_web_ethereum_i18n_TranslateProvider__V = (function(provider) {
  var allKeys = [];
  var aliases = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary($m_sci_Nil$());
  var xs = $m_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$().languages$1;
  var i = 0;
  var len = xs.u.length;
  while ((i < len)) {
    var index = i;
    var arg1 = xs.u[index];
    var language = $as_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(arg1);
    allKeys.push(language.code$1);
    aliases[language.keys$1] = language.code$1;
    i = ((1 + i) | 0)
  };
  provider.useStaticFilesLoader($m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("prefix", "_locales/"), new $c_T2().init___O__O("suffix", ".json")]))).useSanitizeValueStrategy("escape").fallbackLanguage("en").registerAvailableLanguageKeys(allKeys, aliases).determinePreferredLanguage()
});
var $d_Lco_ledger_wallet_web_ethereum_i18n_I18n$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_i18n_I18n$: 0
}, false, "co.ledger.wallet.web.ethereum.i18n.I18n$", {
  Lco_ledger_wallet_web_ethereum_i18n_I18n$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18n$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_i18n_I18n$;
var $n_Lco_ledger_wallet_web_ethereum_i18n_I18n$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_i18n_I18n$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_i18n_I18n$)) {
    $n_Lco_ledger_wallet_web_ethereum_i18n_I18n$ = new $c_Lco_ledger_wallet_web_ethereum_i18n_I18n$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_i18n_I18n$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$() {
  $c_O.call(this);
  this.en$1 = null;
  this.it$1 = null;
  this.languages$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$.prototype = $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$.prototype;
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$.prototype.init___ = (function() {
  $n_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$ = this;
  this.en$1 = new $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry().init___T__T__T("en", "English", "en_*");
  this.it$1 = new $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry().init___T__T__T("it", "Italian", "it_*");
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.en$1, this.it$1]);
  var len = $uI(xs.array$6.length);
  var array = $newArrayObject($d_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.getArrayOf(), [len]);
  var elem$1 = 0;
  elem$1 = 0;
  ...
  this.languages$1 = array;
  return this
});
var $d_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$: 0
}, false, "co.ledger.wallet.web.ethereum.i18n.I18nLanguagesManifest$", {
  Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$;
var $n_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$)) {
    $n_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$ = new $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$
}
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_services_WindowService$() {
  $c_O.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_services_WindowService$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_services_WindowService$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_services_WindowService$.prototype = $c_Lco_ledger_wallet_web_ethereum_services_WindowService$.prototype;
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$.prototype.init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module = (function(module) {
  return module.factory("windowService", [(function() {
    return new $c_Lco_ledger_wallet_web_ethereum_services_WindowService().init___()
  })])
});
var $d_Lco_ledger_wallet_web_ethereum_services_WindowService$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_services_WindowService$: 0
}, false, "co.ledger.wallet.web.ethereum.services.WindowService$", {
  Lco_ledger_wallet_web_ethereum_services_WindowService$: 1,
  O: 1
});
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_services_WindowService$;
var $n_Lco_ledger_wallet_web_ethereum_services_WindowService$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_services_WindowService$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_services_WindowService$)) {
    $n_Lco_ledger_wallet_web_ethereum_services_WindowService$ = new $c_Lco_ledger_wallet_web_ethereum_services_WindowService$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_services_WindowService$
}
/** @constructor */
...
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_Application$() {
  $c_O.call(this);
  this.$$undmodule$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_Application$.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_Application$.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_Application$;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_Application$() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_Application$.prototype = $c_Lco_ledger_wallet_web_ethereum_Application$.prototype;
$c_Lco_ledger_wallet_web_ethereum_Application$.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_Application$.prototype.run__V = (function() {
  var $$this = $m_Lbiz_enef_angulate_package$().angular$1;
  var requires = $as_sc_Iterable($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["ngRoute", "pascalprecht.translate"])));
  var this$5 = $m_sjsr_package$();
  if ($is_sjs_js_ArrayOps(requires)) {
    var x2 = $as_sjs_js_ArrayOps(requires);
    var jsx$1 = x2.scala$scalajs$js$ArrayOps$$array$f
  } else if ($is_sjs_js_WrappedArray(requires)) {
    var x3 = $as_sjs_js_WrappedArray(requires);
    var jsx$1 = x3.array$6
  } else {
    var result = [];
    requires.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, result$1) {
      return (function(x$2) {
  ...
  var module = $$this.module("app", jsx$1);
  this.$$undmodule$1 = module;
  $m_Lco_ledger_wallet_web_ethereum_components_NavigationBar$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_RefreshButton$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_LButton$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_ProgressBar$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_Spinner$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_SnackBar$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_components_Selector$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_controllers_WindowController$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_services_WindowService$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  $m_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$().init__Lbiz_enef_angulate_Module__Lbiz_enef_angulate_Module(module);
  var configFn = ["$routeProvider", (function($$$routeProvider) {
    return $m_Lco_ledger_wallet_web_ethereum_Routes$().declare__Lbiz_enef_angulate_ext_RouteProvider__Lbiz_enef_angulate_ext_RouteProvider($$$routeProvider)
  })];
  module.config(configFn);
  var configFn$1 = ["$compileProvider", (function($$$compileProvider) {
    $$$compileProvider.aHrefSanitizationWhitelist((0, $g.RegExp)("^\\s*(https?|ftp|mailto|file|chrome-extension):"));
    return $$$compileProvider.imgSrcSanitizationWhitelist((0, $g.RegExp)("^\\s*(https?|ftp|mailto|file|chrome-extension):"))
  })];
  module.config(configFn$1);
  var configFn$2 = ["$translateProvider", (function($$$translateProvider) {
    $m_Lco_ledger_wallet_web_ethereum_i18n_I18n$().init__Lco_ledger_wallet_web_ethereum_i18n_TranslateProvider__V($$$translateProvider)
  })];
  module.config(configFn$2);
  var initializationFn = ["$http", "$rootScope", "$location", (function($$$http, $$$rootScope, $$$location) {
    $m_Lco_ledger_wallet_web_ethereum_Application$().initApp__Lbiz_enef_angulate_core_HttpService__sjs_js_Dynamic__sjs_js_Dynamic__V($$$http, $$$rootScope, $$$location)
  })];
  module.run(initializationFn)
});
$c_Lco_ledger_wallet_web_ethereum_Application$.prototype.$$js$exported$meth$main__O = (function() {
  this.run__V()
});
$c_Lco_ledger_wallet_web_ethereum_Application$.prototype.initApp__Lbiz_enef_angulate_core_HttpService__sjs_js_Dynamic__sjs_js_Dynamic__V = (function($$http, $$rootScope, $$location) {
  $$rootScope.location = $$location
});
$c_Lco_ledger_wallet_web_ethereum_Application$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lco_ledger_wallet_web_ethereum_Application$ = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_Application$: 0
}, false, "co.ledger.wallet.web.ethereum.Application$", {
  Lco_ledger_wallet_web_ethereum_Application$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lco_ledger_wallet_web_ethereum_Application$.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_Application$;
var $n_Lco_ledger_wallet_web_ethereum_Application$ = (void 0);
function $m_Lco_ledger_wallet_web_ethereum_Application$() {
  if ((!$n_Lco_ledger_wallet_web_ethereum_Application$)) {
    $n_Lco_ledger_wallet_web_ethereum_Application$ = new $c_Lco_ledger_wallet_web_ethereum_Application$().init___()
  };
  return $n_Lco_ledger_wallet_web_ethereum_Application$
}
$e.co = ($e.co || {});
$e.co.ledger = ($e.co.ledger || {});
$e.co.ledger.wallet = ($e.co.ledger.wallet || {});
$e.co.ledger.wallet.web = ($e.co.ledger.wallet.web || {});
$e.co.ledger.wallet.web.ethereum = ($e.co.ledger.wallet.web.ethereum || {});
$e.co.ledger.wallet.web.ethereum.Application = $m_Lco_ledger_wallet_web_ethereum_Application$;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar() {
  $c_O.call(this);
...
var $d_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar = new $TypeData().initClass({
  ...
  Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar: 1,
  O: 1,
  Lbiz_enef_angulate_Directive: 1
});
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar() {
  $c_O.call(this);
  this.co$ledger$wallet$web$ethereum$components$NavigationBar$$$location$f = null;
  this.co$ledger$wallet$web$ethereum$components$NavigationBar$$$route$f = null;
  this.chains$1 = null;
  this.items$1 = null;
  this.rightItems$1 = null;
  this.synchronize$1 = null;
  this.restrict$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar;
...
$h_Lco_ledger_wallet_web_ethereum_components_NavigationBar.prototype = $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar.prototype.init___Lbiz_enef_angulate_core_Location__sjs_js_Dynamic = (function($$location, $$route) {
  this.co$ledger$wallet$web$ethereum$components$NavigationBar$$$location$f = $$location;
  this.co$ledger$wallet$web$ethereum$components$NavigationBar$$$route$f = $$route;
  this.restrict$1 = "EACM";
  this.chains$1 = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("eth", "launch.eth"), new $c_T2().init___O__O("ethc", "launch.etc")]));
  this.items$1 = [$m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("img", "images/navigation_bar/ic_home.png"), new $c_T2().init___O__O("url", "#account/0")])), $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("img", "images/navigation_bar/ic_send.png"), new $c_T2().init___O__O("url", "#send")])), $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("img", "images/navigation_bar/ic_receive.png"), new $c_T2().init___O__O("url", "#receive")]))];
  this.rightItems$1 = [$m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("img", "images/navigation_bar/ic_help.png"), new $c_T2().init___O__O("url", "#help")]))];
  this.synchronize$1 = $m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("img", "images/refresh_button/ic_white_refresh.png")]));
  var array = this.items$1;
  var i = 0;
  var len = $uI(array.length);
  while ((i < len)) {
    var index = i;
    var arg1 = array[index];
    if ($uZ($m_sjs_js_WrappedDictionary$Cache$().safeHasOwnProperty$1.call(arg1, "url"))) {
      var jsx$1 = arg1.url
    } else {
      var jsx$1;
      throw new $c_ju_NoSuchElementException().init___T("key not found: url")
    };
    var thiz = $as_T(jsx$1);
    arg1.path = ("/" + $as_T(thiz.substring(1)));
    i = ((1 + i) | 0)
  };
  var array$1 = this.rightItems$1;
  var i$1 = 0;
  var len$1 = $uI(array$1.length);
  while ((i$1 < len$1)) {
    var index$1 = i$1;
    var arg1$1 = array$1[index$1];
    if ($uZ($m_sjs_js_WrappedDictionary$Cache$().safeHasOwnProperty$1.call(arg1$1, "url"))) {
      var jsx$2 = arg1$1.url
    } else {
      var jsx$2;
      throw new $c_ju_NoSuchElementException().init___T("key not found: url")
    };
    var thiz$1 = $as_T(jsx$2);
    arg1$1.path = ("/" + $as_T(thiz$1.substring(1)));
    i$1 = ((1 + i$1) | 0)
  };
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar.prototype.controller__sjs_js_Any__sjs_js_Dynamic__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V = (function(ctrl, scope, elem, attrs) {
  scope.items = this.items$1;
  scope.rightItems = this.rightItems$1;
  scope.synchronize = this.synchronize$1;
  scope.isRefreshing = false;
  scope.refresh = (function(scope$1, attrs$1) {
    return (function() {
      return scope$1.$eval(attrs$1.onClickRefresh)
    })
  })(scope, attrs);
  scope.switchChain = (function(arg$outer) {
    return (function() {
      arg$outer.co$ledger$wallet$web$ethereum$components$NavigationBar$$$location$f.url("/onboarding/chain/select");
      return arg$outer.co$ledger$wallet$web$ethereum$components$NavigationBar$$$route$f.reload()
    })
  })(this);
  scope.isSelected = (function(arg$outer$1) {
    return (function(itemPath$2, currentPath$2) {
      var itemPath = $as_T(itemPath$2);
      var currentPath = $as_T(currentPath$2);
      return (($uI(currentPath.length) >= 0) && ($as_T(currentPath.substring(0, $uI(itemPath.length))) === itemPath))
    })
  })(this)
});
var $d_Lco_ledger_wallet_web_ethereum_components_NavigationBar = new $TypeData().initClass({
...
function $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner() {
  $c_O.call(this);
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1 = false;
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1 = null;
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undoverlay$1 = null;
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undbuffer$1 = null;
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undstream$1 = null;
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undscope$1 = null;
  this.restrict$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner;
...
$h_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.postLink__Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$Controller__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__sjs_js_Any__V = (function(scope, element, attrs, controller) {
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1 = element.find("video")[0];
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undoverlay$1 = element.find("#overlay")[0];
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undbuffer$1 = element.find("#buffer")[0]
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.init___ = (function() {
  this.restrict$1 = "EACM";
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1 = false;
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.width__I = (function() {
  return $uI(this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undoverlay$1.width)
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.controller__sjs_js_Any__Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$Controller__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V = (function(ctrl, scope, elem, attrs) {
  scope.start = (function(arg$outer) {
    return (function() {
      arg$outer.start__V()
    })
  })(this);
  scope.stop = (function(arg$outer$1) {
    return (function() {
      arg$outer$1.stop__V()
    })
  })(this);
  scope.width = 370;
  scope.height = 240;
  scope.$on("$destroy", (function(arg$outer$2) {
    return (function() {
      arg$outer$2.stop__V()
    })
  })(this));
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undscope$1 = scope
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$clearRenderingBuffer__V = (function() {
  var ctx = this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undbuffer$1.getContext("2d");
  ctx.clearRect(0.0, 0.0, this.width__I(), this.height__I())
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.start__V = (function() {
  if ((!this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1)) {
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1 = true;
    $g.navigator.webkitGetUserMedia($m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("video", true)])), (function(f) {
      return (function(arg1) {
        return f.apply__O__O(arg1)
      })
    })(new $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1().init___Lco_ledger_wallet_web_ethereum_components_QrCodeScanner(this)), (function(error$2) {
      return (void 0)
    }))
  }
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.height__I = (function() {
  return $uI(this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undoverlay$1.height)
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$scheduleQrCodeDecoder__V = (function() {
  $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(1000.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
    return (function() {
      var context = arg$outer.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undbuffer$1.getContext("2d");
      context.drawImage(arg$outer.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1, 0.0, 0.0, arg$outer.width__I(), arg$outer.height__I());
      var result = $g.zbarProcessImageData(context.getImageData(0.0, 0.0, arg$outer.width__I(), arg$outer.height__I()));
      if ((($uI(result.length) > 0) && ($as_T(result[0][0]) === "QR-Code"))) {
        var qrCode = $as_T(result[0][2]);
        arg$outer.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undscope$1.$emit("qr-code", qrCode);
        arg$outer.stop__V()
      } else if (arg$outer.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1) {
        arg$outer.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$scheduleQrCodeDecoder__V()
      }
    })
  })(this)))
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$roundedRect__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__I__I__I__V = (function(ctx, x, y, w, h, radius) {
  ctx.save();
  ctx.beginPath();
  ctx.moveTo(((x + radius) | 0), y);
  ctx.lineTo(((((x + w) | 0) - radius) | 0), y);
  ctx.quadraticCurveTo(((x + w) | 0), y, ((x + w) | 0), ((y + radius) | 0));
  ctx.lineTo(((x + w) | 0), ((((y + h) | 0) - radius) | 0));
  ctx.quadraticCurveTo(((x + w) | 0), ((y + h) | 0), ((((x + w) | 0) - radius) | 0), ((y + h) | 0));
  ctx.lineTo(((x + radius) | 0), ((y + h) | 0));
  ctx.quadraticCurveTo(x, ((y + h) | 0), x, ((((y + h) | 0) - radius) | 0));
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.stop__V = (function() {
  if (this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1) {
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1 = false;
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$performStop__V()
  }
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(ctx) {
  var w = this.width__I();
  var h = this.height__I();
  var frameX = (((((-170) + w) | 0) / 2) | 0);
  var frameY = (((((-170) + h) | 0) / 2) | 0);
  ctx.save();
  ctx.clearRect(0.0, 0.0, w, h);
  ctx.beginPath();
  var s = new $c_Lorg_scalajs_dom_ext_Color().init___I__I__I(0, 0, 0).toString__T();
  ctx.fillStyle = s;
  ctx.globalAlpha = 0.3;
  ...
  ctx.beginPath();
  ctx.beginPath();
  var s$1 = new $c_Lorg_scalajs_dom_ext_Color().init___I__I__I(255, 255, 255).toString__T();
  ctx.fillStyle = s$1;
  ctx.globalAlpha = 0.75;
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$roundedRect__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__I__I__I__V(ctx, frameX, frameY, 170, 170, 5);
  ctx.fill();
  ctx.beginPath();
  ctx.globalAlpha = 1.0;
  ctx.globalCompositeOperation = "destination-out";
  this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$roundedRect__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__I__I__I__V(ctx, ((5 + frameX) | 0), ((5 + frameY) | 0), 160, 160, 5);
  ctx.rect(((30 + frameX) | 0), frameY, 110, 170);
  ctx.rect(frameX, ((30 + frameY) | 0), 170, 110);
  ctx.fill();
  ctx.restore()
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner.prototype.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$performStop__V = (function() {
  if ((this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undstream$1 !== null)) {
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undstream$1.getTracks()[0].stop();
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undstream$1 = null;
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1.pause();
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1.src = "";
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1.load();
    this.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$clearRenderingBuffer__V()
  }
});
var $d_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_QrCodeScanner: 0
...
function $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer() {
  ...
  this.DefaultDarkColor$1 = null;
  this.DefaultLightColor$1 = null;
  this.DefaultCorrectionLevel$1 = null;
  this.controllerAs$1 = null;
  this.restrict$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer;
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer.prototype.init___ = (function() {
  this.restrict$1 = "EACM";
  this.DefaultWidth$1 = 138;
  this.DefaultHeight$1 = 138;
  this.DefaultDarkColor$1 = "#000000";
  this.DefaultLightColor$1 = "#ffffff";
  this.DefaultCorrectionLevel$1 = $g.QRCode.CorrectLevel.H;
  this.controllerAs$1 = "directive";
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer.prototype.template__T = (function() {
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer.prototype.postLink__Lbiz_enef_angulate_Scope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__sjs_js_Dynamic__V = (function(scope, element, attrs, controller) {
  ...
  scope.$watch(jsx$1, (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2().init___Lco_ledger_wallet_web_ethereum_components_QrCodeViewer__sjs_js_Dynamic(this, controller)))
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer.prototype.controller__sjs_js_Dynamic__Lbiz_enef_angulate_Scope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V = (function(ctrl, scope, elem, attrs) {
  var jsx$9 = $g.QRCode;
  var jsx$8 = elem.find("#qrcode_container")[0];
  var jsx$7 = $m_sjs_js_Dictionary$();
  var y = attrs.value;
  var jsx$6 = new $c_T2().init___O__O("text", y);
  var $$this = attrs.width;
  if (($$this === (void 0))) {
    var $$this$2 = (void 0)
  } else {
    var x$1 = $as_T($$this);
    var this$10 = new $c_sci_StringOps().init___T(x$1);
    var this$12 = $m_jl_Integer$();
    var s = this$10.repr$1;
    var $$this$2 = this$12.parseInt__T__I__I(s, 10)
  };
  var y$1 = (($$this$2 === (void 0)) ? this.DefaultWidth$1 : $$this$2);
  var jsx$5 = new $c_T2().init___O__O("width", y$1);
  var $$this$3 = attrs.height;
  if (($$this$3 === (void 0))) {
    var $$this$5 = (void 0)
  } else {
    var x$2 = $as_T($$this$3);
    ...
    var s$1 = this$23.repr$1;
    var $$this$5 = this$25.parseInt__T__I__I(s$1, 10)
  };
  var y$2 = (($$this$5 === (void 0)) ? this.DefaultHeight$1 : $$this$5);
  var jsx$4 = new $c_T2().init___O__O("height", y$2);
  var $$this$6 = attrs.dark;
  var y$3 = (($$this$6 === (void 0)) ? this.DefaultDarkColor$1 : $$this$6);
  var jsx$3 = new $c_T2().init___O__O("colorDark", y$3);
  var $$this$7 = attrs.light;
  var y$4 = (($$this$7 === (void 0)) ? this.DefaultLightColor$1 : $$this$7);
  var jsx$2 = new $c_T2().init___O__O("colorLight", y$4);
  var $$this$8 = attrs.correctLevel;
  if (($$this$8 === (void 0))) {
    var $$this$10 = (void 0)
  } else {
    var x$3 = $as_T($$this$8);
    var this$46 = new $c_sci_StringOps().init___T(x$3);
    var this$48 = $m_jl_Integer$();
    var s$2 = this$46.repr$1;
    var $$this$10 = this$48.parseInt__T__I__I(s$2, 10)
  };
  var y$5 = (($$this$10 === (void 0)) ? this.DefaultCorrectionLevel$1 : $$this$10);
  var jsx$1 = new jsx$9(jsx$8, jsx$7.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$6, jsx$5, jsx$4, jsx$3, jsx$2, new $c_T2().init___O__O("correctLevel", y$5)])));
  ctrl.qrCode = jsx$1
});
var $d_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_QrCodeViewer: 0
...
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar() {
  ...
  this.show$1 = null;
  this.co$ledger$wallet$web$ethereum$components$SnackBar$$Icons$1 = null;
  this.restrict$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar;
...
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar.prototype.init___sjs_js_Dynamic = (function($$translate) {
  this.$$translate$1 = $$translate;
  this.restrict$1 = "EACM";
  this.show$1 = null;
  this.co$ledger$wallet$web$ethereum$components$SnackBar$$Icons$1 = ["images/snackbar/ic_success.png", "images/snackbar/ic_failure.png", "images/snackbar/ic_success.png"];
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar.prototype.co$ledger$wallet$web$ethereum$components$SnackBar$$tr__T__T = (function(str) {
  return $as_T(this.$$translate$1.instant(str))
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar.prototype.controller__sjs_js_Any__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarScope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V = (function(ctrl, scope, elem, attrs) {
  scope.create = (function(arg$outer) {
    return (function() {
      return new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance().init___Lco_ledger_wallet_web_ethereum_components_SnackBar(arg$outer)
    })
  })(this);
  var currentInstance = new $c_sr_ObjectRef().init___O(null);
  var element = (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)(elem.find("> div")[0]);
  scope.isSuccess = (function(f) {
    return (function() {
      return f.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1().init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef(this, currentInstance));
  scope.isError = (function(f$1) {
    return (function() {
      return f$1.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2().init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef(this, currentInstance));
  scope.isNeutral = (function(f$2) {
    return (function() {
      return f$2.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3().init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef(this, currentInstance));
  scope.title = (function(f$3) {
    return (function() {
      return f$3.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6().init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef(this, currentInstance));
  scope.subtitle = (function(f$4) {
    return (function() {
      return f$4.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7().init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef(this, currentInstance));
  scope.icon = (function(f$5) {
    return (function() {
      return f$5.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8().init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef(this, currentInstance));
  scope.dismiss = (function(f$6) {
    return (function() {
      return f$6.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4().init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef__Lorg_scalajs_jquery_JQuery(this, currentInstance, element));
  this.show$1 = (function(f$7) {
    return (function(arg1) {
      return f$7.apply__O__O(arg1)
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9().init___Lco_ledger_wallet_web_ethereum_components_SnackBar__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarScope__sr_ObjectRef__Lorg_scalajs_jquery_JQuery(this, scope, currentInstance, element))
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar", {
...
function $c_Lco_ledger_wallet_web_ethereum_components_Spinner() {
  $c_O.call(this);
  this.co$ledger$wallet$web$ethereum$components$Spinner$$$parse$f = null;
  this.restrict$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_Spinner;
...
$h_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype = $c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.startAnimation$1__p1__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_JQLite__V = (function(scope$1, element$1) {
  scope$1.destroyed = false;
  scope$1.canvas = element$1.find("#canvas")[0];
  scope$1.ctx = scope$1.canvas.getContext("2d");
  scope$1.startTime = new $c_ju_Date().init___().getTime__J();
  scope$1.revolutionTime = new $c_sjsr_RuntimeLong().init___I__I(1000, 0);
  scope$1.interval = $g.requestAnimationFrame((function(arg$outer, scope$1$1) {
    return (function() {
      arg$outer.co$ledger$wallet$web$ethereum$components$Spinner$$draw__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__V(scope$1$1)
    })
  })(this, scope$1));
  scope$1.$on("$destroy", (function(scope$1$2) {
    return (function() {
      scope$1$2.destroyed = true
    })
  })(scope$1))
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.interpolation$1__p1__D__D = (function(e) {
  var a = (1.5707963267948966 * e);
  return (1.0 - $uD($g.Math.cos(a)))
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.postLink__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V = (function(scope, element, attrs) {
  var isVisible = (function(f) {
    return (function() {
      return f.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1().init___Lco_ledger_wallet_web_ethereum_components_Spinner__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_Attributes(this, scope, attrs));
  var value = attrs.ngShow;
  if ((value === (void 0))) {
    var jsx$1 = (void 0)
  } else {
    var value$1 = $as_T(value);
  ...
  scope.$watch(jsx$1, (function(arg$outer, scope$1, element$1, isVisible$1) {
    return (function() {
      arg$outer.co$ledger$wallet$web$ethereum$components$Spinner$$startAnimationIfNecessary$1__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_JQLite__sjs_js_Function0__V(scope$1, element$1, isVisible$1)
    })
  })(this, scope, element, isVisible));
  this.co$ledger$wallet$web$ethereum$components$Spinner$$startAnimationIfNecessary$1__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_JQLite__sjs_js_Function0__V(scope, element, isVisible)
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.template__T = (function() {
  var this$2 = new $c_sci_StringOps().init___T("\n      |<div style=\"width: 50px; height: 50px\">\n      |  <canvas id=\"canvas\" width=\"50\" height=\"50\"></canvas>\n      |</div>\n    ");
  return $s_sci_StringLike$class__stripMargin__sci_StringLike__C__T(this$2, 124)
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.co$ledger$wallet$web$ethereum$components$Spinner$$draw__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__V = (function(scope) {
  var ctx = scope.ctx;
  var canvas = scope.canvas;
  var startTime = $uJ(scope.startTime);
  var revolutionTime = $uJ(scope.revolutionTime);
  var width = $uI(canvas.width);
  var height = $uI(canvas.height);
  var radius = (((-3) + ((((width < height) ? width : height) / 2) | 0)) | 0);
  var x = ((width / 2) | 0);
  var y = ((height / 2) | 0);
  var t = new $c_ju_Date().init___().getTime__J().$$minus__sjsr_RuntimeLong__sjsr_RuntimeLong(startTime);
  ctx.clearRect(0.0, 0.0, width, height);
  ctx.save();
  ctx.translate(x, y);
  var e = (t.$$percent__sjsr_RuntimeLong__sjsr_RuntimeLong(revolutionTime).toDouble__D() / revolutionTime.toDouble__D());
  ctx.rotate(((3.141592653589793 * (360 * this.easing$1__p1__D__D(e))) / 180));
  ...
  ctx.globalAlpha = 1.0;
  ctx.globalCompositeOperation = "destination-out";
  ctx.rect(((width / 2) | 0), ((height / 2) | 0), ((width / 2) | 0), ((height / 2) | 0));
  ctx.fill();
  ctx.restore();
  if ((!$uZ(scope.destroyed))) {
    $g.requestAnimationFrame((function(arg$outer, scope$2) {
      return (function() {
        arg$outer.co$ledger$wallet$web$ethereum$components$Spinner$$draw__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__V(scope$2)
      })
    })(this, scope))
  }
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.init___sjs_js_Dynamic = (function($$parse) {
  this.co$ledger$wallet$web$ethereum$components$Spinner$$$parse$f = $$parse;
  this.restrict$1 = "EACM";
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.easing$1__p1__D__D = (function(e$1) {
  return ((e$1 >= 0.5) ? ((2.0 - this.interpolation$1__p1__D__D((2 + ((-2) * e$1)))) / 2) : (this.interpolation$1__p1__D__D((2 * e$1)) / 2))
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner.prototype.co$ledger$wallet$web$ethereum$components$Spinner$$startAnimationIfNecessary$1__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_JQLite__sjs_js_Function0__V = (function(scope$1, element$1, isVisible$1) {
  if ($uZ(isVisible$1())) {
    this.startAnimation$1__p1__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_JQLite__V(scope$1, element$1)
  } else {
    scope$1.destroyed = true
  }
});
var $d_Lco_ledger_wallet_web_ethereum_components_Spinner = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_Spinner: 0
...
function $c_Lco_ledger_wallet_web_ethereum_services_WindowService() {
  $c_O.call(this);
  this.$$unduserInterfaceEnableListener$1 = null;
  this.co$ledger$wallet$web$ethereum$services$WindowService$$$undrefreshing$1 = false;
  this.$$undnavigationBarVisibilityListener$1 = null;
  this.co$ledger$wallet$web$ethereum$services$WindowService$$$undnavigationIsVisible$1 = false;
  this.$$undrefreshHandler$1 = null;
  this.$$undwindowController$1 = null;
  this.configureSnackBar$1 = null;
  this.StartRefresh$module$1 = null;
  this.StopRefresh$module$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_services_WindowService;
/** @constructor */
...
$h_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype = $c_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype;
$c_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype.init___ = (function() {
  this.$$unduserInterfaceEnableListener$1 = $m_s_None$();
  this.co$ledger$wallet$web$ethereum$services$WindowService$$$undrefreshing$1 = false;
  this.$$undnavigationBarVisibilityListener$1 = $m_s_None$();
  this.co$ledger$wallet$web$ethereum$services$WindowService$$$undnavigationIsVisible$1 = false;
  this.$$undrefreshHandler$1 = $m_s_None$();
  this.$$undwindowController$1 = null;
  this.configureSnackBar$1 = new $c_sjsr_AnonFunction3().init___sjs_js_Function3((function(x$5$2, x$6$2, x$7$2) {
    $uI(x$5$2);
    $as_T(x$6$2);
    $as_T(x$7$2);
    return null
...
$c_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype.hideNavigationBar__V = (function() {
  if (this.co$ledger$wallet$web$ethereum$services$WindowService$$$undnavigationIsVisible$1) {
    this.co$ledger$wallet$web$ethereum$services$WindowService$$$undnavigationIsVisible$1 = false;
    var this$1 = this.$$undnavigationBarVisibilityListener$1;
    if ((!this$1.isEmpty__Z())) {
      var arg1 = this$1.get__O();
      var x$4 = $as_F1(arg1);
      x$4.apply__O__O(this.co$ledger$wallet$web$ethereum$services$WindowService$$$undnavigationIsVisible$1)
    }
  }
});
$c_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype.notifyRefresh__V = (function() {
  if ((this.$$undrefreshHandler$1.isDefined__Z() && (!this.co$ledger$wallet$web$ethereum$services$WindowService$$$undrefreshing$1))) {
    var start = new $c_ju_Date().init___().getTime__J();
    this.co$ledger$wallet$web$ethereum$services$WindowService$$$undrefreshing$1 = true;
    $as_s_concurrent_Future($as_F0(this.$$undrefreshHandler$1.get__O()).apply__O()).onComplete__F1__s_concurrent_ExecutionContext__V(new $c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1().init___Lco_ledger_wallet_web_ethereum_services_WindowService__J(this, start), $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor())
  }
});
$c_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype.onUserInterfaceEnableChanged__F1__V = (function(handler) {
  this.$$unduserInterfaceEnableListener$1 = $m_s_Option$().apply__O__s_Option(handler)
});
$c_Lco_ledger_wallet_web_ethereum_services_WindowService.prototype.onNavigationBarVisibilityChanged__F1__V = (function(handler) {
  this.$$undnavigationBarVisibilityListener$1 = $m_s_Option$().apply__O__s_Option(handler)
});
function $is_Lco_ledger_wallet_web_ethereum_services_WindowService(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lco_ledger_wallet_web_ethereum_services_WindowService)))
}
function $as_Lco_ledger_wallet_web_ethereum_services_WindowService(obj) {
  return (($is_Lco_ledger_wallet_web_ethereum_services_WindowService(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "co.ledger.wallet.web.ethereum.services.WindowService"))
}
function $isArrayOf_Lco_ledger_wallet_web_ethereum_services_WindowService(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lco_ledger_wallet_web_ethereum_services_WindowService)))
}
function $asArrayOf_Lco_ledger_wallet_web_ethereum_services_WindowService(obj, depth) {
  return (($isArrayOf_Lco_ledger_wallet_web_ethereum_services_WindowService(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lco.ledger.wallet.web.ethereum.services.WindowService;", depth))
}
var $d_Lco_ledger_wallet_web_ethereum_services_WindowService = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_services_WindowService: 0
}, false, "co.ledger.wallet.web.ethereum.services.WindowService", {
...
$c_sr_AbstractFunction5.prototype.toString__T = (function() {
  return "<function5>"
});
/** @constructor */
...
$c_sr_AbstractFunction6.prototype.toString__T = (function() {
  return "<function6>"
});
/** @constructor */
...
function $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController() {
  $c_O.call(this);
  this.windowService$1 = null;
  this.co$ledger$wallet$web$ethereum$controllers$WindowController$$$scope$f = null;
  this.showNavigationBar$1 = false;
  this.isUiEnabled$1 = false;
  this.co$ledger$wallet$web$ethereum$controllers$WindowController$$$undsnackBarScope$1 = null;
  this.co$ledger$wallet$web$ethereum$controllers$WindowController$$$undnavigationBarScope$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController;
/** @constructor */
...
$h_Lco_ledger_wallet_web_ethereum_controllers_WindowController.prototype = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController.prototype;
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController.prototype.refresh__V = (function() {
  this.windowService$1.notifyRefresh__V()
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController.prototype.init___Lco_ledger_wallet_web_ethereum_services_WindowService__Lbiz_enef_angulate_Scope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_JQLite = (function(windowService, $$scope, $$element, $$document) {
  this.windowService$1 = windowService;
  this.co$ledger$wallet$web$ethereum$controllers$WindowController$$$scope$f = $$scope;
  this.showNavigationBar$1 = false;
  $$document.on("keydown", (function(e$2) {
    return ((($uD(e$2.which) === 8) && (($as_T(e$2.target.nodeName) !== "INPUT") && ($as_T(e$2.target.nodeName) !== "SELECT"))) ? e$2.preventDefault() : (void 0))
  }));
  windowService.onNavigationBarVisibilityChanged__F1__V(new $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2().init___Lco_ledger_wallet_web_ethereum_controllers_WindowController(this));
  windowService.configureSnackBar$1 = new $c_sjsr_AnonFunction3().init___sjs_js_Function3((function(arg$outer) {
    return (function(mode$2, title$2, subtitle$2) {
      var mode = $uI(mode$2);
      var title = $as_T(title$2);
      var subtitle = $as_T(subtitle$2);
      return $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance((0, arg$outer.co$ledger$wallet$web$ethereum$controllers$WindowController$$$undsnackBarScope$1.create)()).mode__I__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(mode).title__T__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(title).subtitle__T__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(subtitle)
    })
  })(this));
  this.isUiEnabled$1 = true;
  windowService.onUserInterfaceEnableChanged__F1__V(new $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4().init___Lco_ledger_wallet_web_ethereum_controllers_WindowController(this));
  this.co$ledger$wallet$web$ethereum$controllers$WindowController$$$undsnackBarScope$1 = $$element.find("> snackbar").scope();
  this.co$ledger$wallet$web$ethereum$controllers$WindowController$$$undnavigationBarScope$1 = $$element.find("> navigation-bar").scope();
  return this
});
var $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_controllers_WindowController: 0
  ...
  Lco_ledger_wallet_web_ethereum_controllers_WindowController: 1,
  O: 1,
  Lbiz_enef_angulate_Controller: 1,
  Lbiz_enef_angulate_NGController: 1
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController;
/** @constructor */
...
$c_s_concurrent_duration_Duration$.prototype.init___ = (function() {
  ...
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(s$2) {
      var s = $as_T(s$2);
      var this$20 = $this.words__p1__T__sci_List(s);
...
$h_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController.prototype = $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController.prototype;
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController.prototype.download__V = (function() {
  $g.open("http://ledger.com/live")
});
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController.prototype.openHelpCenter__V = (function() {
  $g.open("http://support.ledgerwallet.com/")
});
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController.prototype.init___Lco_ledger_wallet_web_ethereum_services_WindowService__Lbiz_enef_angulate_Scope__sjs_js_Dynamic__Lbiz_enef_angulate_core_Location__sjs_js_Dictionary = (function(windowService, $$scope, $$route, $$location, $$routeParams) {
  this.windowService$1 = windowService;
  this.$$scope$1 = $$scope;
  this.windowService$1.hideNavigationBar__V();
  return this
});
var $d_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController: 0
  ...
  Lbiz_enef_angulate_Controller: 1,
  Lbiz_enef_angulate_NGController: 1,
  Lco_ledger_wallet_web_ethereum_controllers_onboarding_OnBoardingController: 1
});
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController;
/** @constructor */
...
/** @constructor */
function $c_sr_AbstractFunction0$mcZ$sp() {
  $c_sr_AbstractFunction0.call(this)
}
$c_sr_AbstractFunction0$mcZ$sp.prototype = new $h_sr_AbstractFunction0();
$c_sr_AbstractFunction0$mcZ$sp.prototype.constructor = $c_sr_AbstractFunction0$mcZ$sp;
/** @constructor */
function $h_sr_AbstractFunction0$mcZ$sp() {
  /*<skip>*/
}
$h_sr_AbstractFunction0$mcZ$sp.prototype = $c_sr_AbstractFunction0$mcZ$sp.prototype;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1() {
  $c_sr_AbstractFunction0.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1.prototype = new $h_sr_AbstractFunction0();
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1.prototype.apply__O = (function() {
  return this.apply__sjs_js_Object()
});
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1.prototype.apply__sjs_js_Object = (function() {
  var dimpl = new $c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar().init___();
  var ddo = {
    "templateUrl": (function(dimpl$1) {
      return (function() {
        return "templates/components/actions-bottom-bar.html"
      })
    })(dimpl),
    "transclude": (function(dimpl$1$1) {
      return (function() {
        return true
      })
    })(dimpl)
...
var $d_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.ActionsBottomBar$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_ActionsBottomBar$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2.prototype = $c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2.prototype.apply__O__O = (function(v1) {
  this.apply__sjs_js_Dynamic__V(v1)
});
$c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2.prototype.apply__sjs_js_Dynamic__V = (function(scope) {
  var ctrl = new $c_Lco_ledger_wallet_web_ethereum_components_LButton().init___();
  $g.Object.defineProperty(scope, "text", {
    "get": (function(ctrl$1) {
      return (function() {
        return ctrl$1.text$1
      })
    })(ctrl),
  ...
  $g.Object.defineProperty(scope, "icon", {
    "get": (function(ctrl$1$2) {
      return (function() {
        return ctrl$1$2.icon$1
      })
    })(ctrl),
  ...
  $g.Object.defineProperty(scope, "type", {
    "get": (function(ctrl$1$4) {
      return (function() {
        return ctrl$1$4.type$1
      })
    })(ctrl),
  ...
  $g.Object.defineProperty(scope, "disabled", {
    "get": (function(ctrl$1$6) {
      return (function() {
        return ctrl$1$6.$$unddisabled$1
      })
    })(ctrl),
    "set": (function(ctrl$1$7) {
      return (function(v$2$3) {
        var v$4 = $as_T(v$2$3);
        ctrl$1$7.disabled$und$eq__T__V(v$4)
      })
    })(ctrl)
  })
});
var $d_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2: 0
}, false, "co.ledger.wallet.web.ethereum.components.LButton$$anonfun$init$2", {
  Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_LButton$$anonfun$init$2;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1() {
  $c_sr_AbstractFunction2.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1.prototype = new $h_sr_AbstractFunction2();
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1.prototype.apply__O__O__O = (function(v1, v2) {
  return this.apply__Lbiz_enef_angulate_core_Location__sjs_js_Dynamic__sjs_js_Object(v1, v2)
});
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1.prototype.apply__Lbiz_enef_angulate_core_Location__sjs_js_Dynamic__sjs_js_Object = (function(x$macro$1, x$macro$2) {
  var dimpl = new $c_Lco_ledger_wallet_web_ethereum_components_NavigationBar().init___Lbiz_enef_angulate_core_Location__sjs_js_Dynamic(x$macro$1, x$macro$2);
  var ddo = {
    "chains": dimpl.chains$1,
    "templateUrl": (function(dimpl$1) {
      return (function() {
        return "templates/components/navigation-bar.html"
      })
    })(dimpl),
    "controller": ["$scope", "$element", "$attrs", (function(f) {
      return (function(arg1, arg2, arg3) {
        return f.apply__O__O__O__O__O(this, arg1, arg2, arg3)
      })
    })(new $c_sjsr_AnonFunction4().init___sjs_js_Function4((function(dimpl$1$1) {
      return (function(ctrl$2, scope$2, elem$2, attrs$2) {
        dimpl$1$1.controller__sjs_js_Any__sjs_js_Dynamic__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V(ctrl$2, scope$2, elem$2, attrs$2)
      })
    })(dimpl)))],
    "isSelected": (function(dimpl$1$2) {
      return (function(itemPath$2, currentPath$2) {
        var itemPath = $as_T(itemPath$2);
        var currentPath = $as_T(currentPath$2);
        return (($uI(currentPath.length) >= 0) && ($as_T(currentPath.substring(0, $uI(itemPath.length))) === itemPath))
    ...
    "items": dimpl.items$1,
    "rightItems": dimpl.rightItems$1,
    "synchronize": dimpl.synchronize$1
  };
  return ddo
});
var $d_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.NavigationBar$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1: 1,
  sr_AbstractFunction2: 1,
  O: 1,
  F2: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_NavigationBar$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2.prototype = $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2.prototype.apply__O__O = (function(v1) {
  this.apply__sjs_js_Dynamic__V(v1)
});
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2.prototype.apply__sjs_js_Dynamic__V = (function(scope) {
  var ctrl = new $c_Lco_ledger_wallet_web_ethereum_components_ProgressBar().init___();
  $g.Object.defineProperty(scope, "width", {
    "get": (function(ctrl$1) {
      return (function() {
        return ctrl$1.width$1
      })
    })(ctrl),
    "set": (function(ctrl$1$1) {
      return (function(v$2) {
  ...
  $g.Object.defineProperty(scope, "animated", {
    "get": (function(ctrl$1$2) {
      return (function() {
        return ctrl$1$2.animated$1
      })
    })(ctrl),
    "set": (function(ctrl$1$3) {
      return (function(v$2$1) {
        var v$1 = $uZ(v$2$1);
        ctrl$1$3.animated$1 = v$1
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "percent", {
    "get": (function(ctrl$1$4) {
      return (function() {
        return ctrl$1$4.percent__I()
      })
    })(ctrl),
    "set": (function(ctrl$1$5) {
      return (function(v$2$2) {
        var v$3 = $as_T(v$2$2);
        ctrl$1$5.percent$und$eq__T__V(v$3)
      })
    })(ctrl)
  })
});
var $d_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2: 0
}, false, "co.ledger.wallet.web.ethereum.components.ProgressBar$$anonfun$init$2", {
  Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_ProgressBar$$anonfun$init$2;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1() {
  $c_sr_AbstractFunction0.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1.prototype = new $h_sr_AbstractFunction0();
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1.prototype.apply__O = (function() {
  return this.apply__sjs_js_Object()
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1.prototype.apply__sjs_js_Object = (function() {
  var dimpl = new $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner().init___();
  var jsx$1 = new $c_sjsr_AnonFunction4().init___sjs_js_Function4((function(dimpl$1$1) {
    return (function(ctrl$2, scope$2, elem$2, attrs$2) {
      dimpl$1$1.controller__sjs_js_Any__Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$Controller__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V(ctrl$2, scope$2, elem$2, attrs$2)
    })
  })(dimpl));
  var value = dimpl.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1;
  var ddo = {
    "templateUrl": (function(dimpl$1) {
      return (function() {
        return "templates/components/qrcode_scanner.html"
      })
    })(dimpl),
    "controller": ["$scope", "$element", "$attrs", (function(f) {
      return (function(arg1, arg2, arg3) {
    ...
    "link": (function(dimpl$1$2) {
      return (function(scope$2$1, element$2, attrs$2$1, controller$2) {
        dimpl$1$2.postLink__Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$Controller__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__sjs_js_Any__V(scope$2$1, element$2, attrs$2$1, controller$2)
      })
    })(dimpl),
    "start": (function(dimpl$1$3) {
      return (function() {
        dimpl$1$3.start__V()
      })
    })(dimpl),
    "stop": (function(dimpl$1$4) {
      return (function() {
        dimpl$1$4.stop__V()
      })
    })(dimpl),
    "clearRenderingBuffer": (function(dimpl$1$5) {
      return (function() {
        dimpl$1$5.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$clearRenderingBuffer__V()
      })
    })(dimpl),
    "performStop": (function(dimpl$1$6) {
      return (function() {
        dimpl$1$6.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$performStop__V()
      })
    })(dimpl),
    "draw": (function(dimpl$1$7) {
      return (function(ctx$2) {
        dimpl$1$7.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(ctx$2)
      })
    })(dimpl),
    "roundedRect": (function(dimpl$1$8) {
      return (function(ctx$2$1, x$2, y$2, w$2, h$2, radius$2) {
        var x = $uI(x$2);
        var y = $uI(y$2);
        var w = $uI(w$2);
        var h = $uI(h$2);
        var radius = $uI(radius$2);
        dimpl$1$8.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$roundedRect__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__I__I__I__I__V(ctx$2$1, x, y, w, h, radius)
      })
    })(dimpl),
    "scheduleQrCodeDecoder": (function(dimpl$1$9) {
      return (function() {
        dimpl$1$9.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$scheduleQrCodeDecoder__V()
      })
    })(dimpl),
    "width": (function(dimpl$1$10) {
      return (function() {
        return dimpl$1$10.width__I()
      })
    })(dimpl),
    "height": (function(dimpl$1$11) {
      return (function() {
        return dimpl$1$11.height__I()
      })
    })(dimpl),
    "_running": value,
    "_running_$eq": (function(dimpl$1$12) {
      return (function(x$1$2) {
        var x$1 = $uZ(x$1$2);
        dimpl$1$12.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1 = x$1
      })
    })(dimpl),
    "_video": dimpl.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1,
    "_video_$eq": (function(dimpl$1$13) {
      return (function(x$1$2$1) {
        dimpl$1$13.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1 = x$1$2$1
      })
    })(dimpl),
    "_overlay": dimpl.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undoverlay$1,
    "_overlay_$eq": (function(dimpl$1$14) {
      return (function(x$1$2$2) {
        dimpl$1$14.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undoverlay$1 = x$1$2$2
      })
    })(dimpl),
    "_buffer": dimpl.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undbuffer$1,
    "_buffer_$eq": (function(dimpl$1$15) {
      return (function(x$1$2$3) {
        dimpl$1$15.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undbuffer$1 = x$1$2$3
      })
    })(dimpl),
    "_stream": dimpl.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undstream$1,
    "_stream_$eq": (function(dimpl$1$16) {
      return (function(x$1$2$4) {
        dimpl$1$16.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undstream$1 = x$1$2$4
      })
    })(dimpl),
    "_scope": dimpl.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undscope$1,
    "_scope_$eq": (function(dimpl$1$17) {
      return (function(x$1$2$5) {
        dimpl$1$17.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undscope$1 = x$1$2$5
      })
    })(dimpl)
  };
  return ddo
});
var $d_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.QrCodeScanner$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1.prototype.apply__O__O = (function(v1) {
  this.apply__sjs_js_Dynamic__V(v1)
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1.prototype.init___Lco_ledger_wallet_web_ethereum_components_QrCodeScanner = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1.prototype.apply__sjs_js_Dynamic__V = (function(stream) {
  this.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undstream$1 = stream;
  this.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1.src = $objectToString($g.URL.createObjectURL(stream));
  this.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1.play();
  this.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1.onplaying = (function(arg$outer) {
    return (function(event$2) {
      arg$outer.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undvideo$1.onplaying = null;
      arg$outer.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$scheduleQrCodeDecoder__V()
    })
  })(this);
  this.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(this.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undoverlay$1.getContext("2d"));
  if ((!this.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$$undrunning$1)) {
    this.$$outer$2.co$ledger$wallet$web$ethereum$components$QrCodeScanner$$performStop__V()
  }
});
var $d_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.QrCodeScanner$$anonfun$start$1", {
  Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_QrCodeScanner$$anonfun$start$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1() {
  $c_sr_AbstractFunction0.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1.prototype = new $h_sr_AbstractFunction0();
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1.prototype.apply__O = (function() {
  return this.apply__sjs_js_Object()
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1.prototype.apply__sjs_js_Object = (function() {
  var dimpl = new $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer().init___();
  var value = dimpl.DefaultWidth$1;
  var value$1 = dimpl.DefaultHeight$1;
  var s = dimpl.DefaultDarkColor$1;
  var s$1 = dimpl.DefaultLightColor$1;
  var jsx$1 = dimpl.DefaultCorrectionLevel$1;
  var s$2 = dimpl.controllerAs$1;
  var ddo = {
    "DefaultWidth": value,
    "DefaultHeight": value$1,
    "DefaultDarkColor": s,
    "DefaultLightColor": s$1,
    "DefaultCorrectionLevel": jsx$1,
    "template": (function(dimpl$1) {
      return (function() {
        return dimpl$1.template__T()
      })
    })(dimpl),
    "controllerAs": s$2,
    "controller": ["$scope", "$element", "$attrs", (function(f) {
      ...
      return (function(ctrl$2, scope$2, elem$2, attrs$2) {
        dimpl$1$1.controller__sjs_js_Dynamic__Lbiz_enef_angulate_Scope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V(ctrl$2, scope$2, elem$2, attrs$2)
      })
    })(dimpl)))],
    "link": (function(dimpl$1$2) {
      return (function(scope$2$1, element$2, attrs$2$1, controller$2) {
        dimpl$1$2.postLink__Lbiz_enef_angulate_Scope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__sjs_js_Dynamic__V(scope$2$1, element$2, attrs$2$1, controller$2)
      })
    })(dimpl)
  };
  return ddo
});
var $d_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.QrCodeViewer$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2() {
  $c_sr_AbstractFunction1.call(this);
  this.controller$1$2 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2.prototype = $c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2.prototype.init___Lco_ledger_wallet_web_ethereum_components_QrCodeViewer__sjs_js_Dynamic = (function($$outer, controller$1) {
  this.controller$1$2 = controller$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2.prototype.apply__O__O = (function(v1) {
  return this.apply__sjs_js_UndefOr__sjs_js_Dynamic(v1)
});
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2.prototype.apply__sjs_js_UndefOr__sjs_js_Dynamic = (function(newValue) {
  var jsx$1 = this.controller$1$2.qrCode;
  var s = $as_T(((newValue === (void 0)) ? "" : newValue));
  return jsx$1.makeCode(s)
});
var $d_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2: 0
}, false, "co.ledger.wallet.web.ethereum.components.QrCodeViewer$$anonfun$postLink$2", {
  Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_QrCodeViewer$$anonfun$postLink$2;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2.prototype = $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2.prototype.apply__O__O = (function(v1) {
  this.apply__sjs_js_Dynamic__V(v1)
});
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2.prototype.apply__sjs_js_Dynamic__V = (function(scope) {
  var ctrl = new $c_Lco_ledger_wallet_web_ethereum_components_RefreshButton().init___();
  $g.Object.defineProperty(scope, "running", {
    "get": (function(ctrl$1) {
      return (function() {
        return ctrl$1.$$undrunning$1
      })
    })(ctrl),
    "set": (function(ctrl$1$1) {
      return (function(v$2) {
        var v = $as_T(v$2);
        ctrl$1$1.running$und$eq__T__V(v)
      })
    })(ctrl)
  })
});
var $d_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2: 0
}, false, "co.ledger.wallet.web.ethereum.components.RefreshButton$$anonfun$init$2", {
  Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_RefreshButton$$anonfun$init$2;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2() {
  $c_sr_AbstractFunction2.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2.prototype = new $h_sr_AbstractFunction2();
$c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2.prototype = $c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2.prototype.apply__sjs_js_Dynamic__Lbiz_enef_angulate_Scope__V = (function(scope, x$macro$5) {
  var ctrl = new $c_Lco_ledger_wallet_web_ethereum_components_Selector().init___Lbiz_enef_angulate_Scope(x$macro$5);
  $g.Object.defineProperty(scope, "values", {
    "get": (function(ctrl$1) {
      return (function() {
        return ctrl$1.$$undvalues$1
      })
    })(ctrl),
    "set": (function(ctrl$1$1) {
      return (function(v$2) {
        ctrl$1$1.values$und$eq__sjs_js_Dictionary__V(v$2)
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "selected", {
    "get": (function(ctrl$1$2) {
      return (function() {
        return ctrl$1$2.$$undselected$1
      })
    })(ctrl),
    "set": (function(ctrl$1$3) {
      return (function(v$2$1) {
        var v = $as_T(v$2$1);
        ctrl$1$3.$$undselected$1 = v
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "_selected", {
    "get": (function(ctrl$1$4) {
      return (function() {
        return ctrl$1$4.$$undselected$1
      })
    })(ctrl),
    "set": (function(ctrl$1$5) {
      return (function(v$2$2) {
        var v$1 = $as_T(v$2$2);
        ctrl$1$5.$$undselected$1 = v$1
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "changed", {
    "get": (function(ctrl$1$6) {
      return (function() {
        return ctrl$1$6.$$undonSelectionChanged$1
      })
    })(ctrl),
    "set": (function(ctrl$1$7) {
      return (function(v$2$3) {
        var v$3 = $as_T(v$2$3);
        ctrl$1$7.changed$und$eq__T__V(v$3)
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "select", {
    "value": (function(ctrl$1$8) {
      return (function(x$macro$6$2) {
        var x$macro$6 = $as_T(x$macro$6$2);
        return ctrl$1$8.select__T__O(x$macro$6)
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "isSelected", {
    "value": (function(ctrl$1$9) {
      return (function(x$macro$7$2) {
        var x$macro$7 = $as_T(x$macro$7$2);
        return ctrl$1$9.isSelected__T__Z(x$macro$7)
      })
    })(ctrl)
  })
});
$c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2.prototype.apply__O__O__O = (function(v1, v2) {
  this.apply__sjs_js_Dynamic__Lbiz_enef_angulate_Scope__V(v1, v2)
});
var $d_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2: 0
}, false, "co.ledger.wallet.web.ethereum.components.Selector$$anonfun$init$2", {
  Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2: 1,
  sr_AbstractFunction2: 1,
  O: 1,
  F2: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_Selector$$anonfun$init$2;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6() {
  $c_sr_AbstractFunction0.call(this);
  this.$$outer$2 = null;
  this.currentInstance$1$2 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6.prototype = new $h_sr_AbstractFunction0();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6.prototype.apply__T = (function() {
  var jsx$1 = this.$$outer$2;
  var this$1 = $m_s_Option$().apply__O__s_Option($as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.currentInstance$1$2.elem$1));
  if (this$1.isEmpty__Z()) {
    var this$2 = $m_s_None$()
  } else {
    var arg1 = this$1.get__O();
    var x$4 = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg1);
    var this$2 = new $c_s_Some().init___O(x$4.$$undtitle$1)
  };
  return jsx$1.co$ledger$wallet$web$ethereum$components$SnackBar$$tr__T__T($as_T((this$2.isEmpty__Z() ? "" : this$2.get__O())))
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef = (function($$outer, currentInstance$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.currentInstance$1$2 = currentInstance$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6.prototype.apply__O = (function() {
  return this.apply__T()
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$6", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$6;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7() {
  $c_sr_AbstractFunction0.call(this);
  this.$$outer$2 = null;
  this.currentInstance$1$2 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7.prototype = new $h_sr_AbstractFunction0();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7.prototype.apply__T = (function() {
  var jsx$1 = this.$$outer$2;
  var this$1 = $m_s_Option$().apply__O__s_Option($as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.currentInstance$1$2.elem$1));
  if (this$1.isEmpty__Z()) {
    var this$2 = $m_s_None$()
    ...
    var arg1 = this$1.get__O();
    var x$5 = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg1);
    var this$2 = new $c_s_Some().init___O(x$5.$$undsubtitle$1)
  };
  return jsx$1.co$ledger$wallet$web$ethereum$components$SnackBar$$tr__T__T($as_T((this$2.isEmpty__Z() ? "" : this$2.get__O())))
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef = (function($$outer, currentInstance$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7.prototype.apply__O = (function() {
  return this.apply__T()
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$7", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$7;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8() {
  $c_sr_AbstractFunction0.call(this);
  this.$$outer$2 = null;
  this.currentInstance$1$2 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8.prototype = new $h_sr_AbstractFunction0();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8.prototype.apply__T = (function() {
  var jsx$2 = this.$$outer$2.co$ledger$wallet$web$ethereum$components$SnackBar$$Icons$1;
  var this$1 = $m_s_Option$().apply__O__s_Option($as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.currentInstance$1$2.elem$1));
  if (this$1.isEmpty__Z()) {
    var this$2 = $m_s_None$()
  } else {
    var arg1 = this$1.get__O();
    var x$6 = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg1);
    var this$2 = new $c_s_Some().init___O(x$6.$$undmode$1)
  };
  var jsx$1 = jsx$2[$uI((this$2.isEmpty__Z() ? 0 : this$2.get__O()))];
  return $as_T(jsx$1)
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef = (function($$outer, currentInstance$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8.prototype.apply__O = (function() {
  return this.apply__T()
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$8", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$8;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9() {
  $c_sr_AbstractFunction1.call(this);
  this.scope$1$f = null;
  this.currentInstance$1$f = null;
  this.element$1$f = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9.prototype.apply__O__O = (function(v1) {
  this.apply__O__V(v1)
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarScope__sr_ObjectRef__Lorg_scalajs_jquery_JQuery = (function($$outer, scope$1, currentInstance$1, element$1) {
  this.scope$1$f = scope$1;
  this.currentInstance$1$f = currentInstance$1;
  this.element$1$f = element$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9.prototype.apply__O__V = (function(a) {
  this.currentInstance$1$f.elem$1 = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(a);
  var timeout = new $c_sr_ObjectRef().init___O(null);
  $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.currentInstance$1$f.elem$1).dismissHandler$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, a$1) {
    return (function() {
      var x = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg$outer.currentInstance$1$f.elem$1);
      if ((x === a$1)) {
        (0, arg$outer.scope$1$f.dismiss)()
      }
    })
  })(this, a));
  $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(0.0, new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3().init___Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9__sr_ObjectRef(this, timeout))
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$9", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1.prototype.apply__O__O = (function(v1) {
  return this.apply__sjs_js_Dynamic__sjs_js_Object(v1)
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1.prototype.apply__sjs_js_Dynamic__sjs_js_Object = (function(x$macro$4) {
  var dimpl = new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar().init___sjs_js_Dynamic(x$macro$4);
  var ddo = {
    "templateUrl": (function(dimpl$1) {
      return (function() {
        return "templates/components/snackbar.html"
      })
    })(dimpl),
    "tr": (function(dimpl$1$1) {
      return (function(str$2) {
        var str = $as_T(str$2);
        return dimpl$1$1.co$ledger$wallet$web$ethereum$components$SnackBar$$tr__T__T(str)
      })
    })(dimpl),
    "controller": ["$scope", "$element", "$attrs", (function(f) {
      return (function(arg1, arg2, arg3) {
    ...
    })(new $c_sjsr_AnonFunction4().init___sjs_js_Function4((function(dimpl$1$2) {
      return (function(ctrl$2, scope$2, elem$2, attrs$2) {
        dimpl$1$2.controller__sjs_js_Any__Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarScope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V(ctrl$2, scope$2, elem$2, attrs$2)
      })
    })(dimpl)))],
    "createInstance": (function(dimpl$1$3) {
      return (function() {
        return new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance().init___Lco_ledger_wallet_web_ethereum_components_SnackBar(dimpl$1$3)
      })
    })(dimpl),
    "show": dimpl.show$1,
    "show_$eq": (function(dimpl$1$4) {
      return (function(x$1$2) {
        dimpl$1$4.show$1 = x$1$2
      })
    })(dimpl),
    "Icons": dimpl.co$ledger$wallet$web$ethereum$components$SnackBar$$Icons$1
  };
  return ddo
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1.prototype.apply__O__O = (function(v1) {
  return this.apply__sjs_js_Dynamic__sjs_js_Object(v1)
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1.prototype.apply__sjs_js_Dynamic__sjs_js_Object = (function(x$macro$3) {
  var dimpl = new $c_Lco_ledger_wallet_web_ethereum_components_Spinner().init___sjs_js_Dynamic(x$macro$3);
  var ddo = {
    "template": (function(dimpl$1) {
      return (function() {
        return dimpl$1.template__T()
    ...
    "link": (function(dimpl$1$1) {
      return (function(scope$2, element$2, attrs$2) {
        dimpl$1$1.postLink__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_Attributes__V(scope$2, element$2, attrs$2)
      })
    })(dimpl),
    "draw": (function(dimpl$1$2) {
      return (function(scope$2$1) {
        dimpl$1$2.co$ledger$wallet$web$ethereum$components$Spinner$$draw__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__V(scope$2$1)
      })
    })(dimpl)
  };
  return ddo
});
var $d_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.Spinner$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2.prototype = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2.prototype;
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2.prototype.apply__O__O = (function(v1) {
  this.apply__Z__V($uZ(v1))
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2.prototype.apply__Z__V = (function(isVisible) {
  this.$$outer$2.showNavigationBar$1 = isVisible;
  $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(0.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
    return (function() {
      arg$outer.$$outer$2.co$ledger$wallet$web$ethereum$controllers$WindowController$$$undnavigationBarScope$1.$apply()
    })
  })(this)))
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2.prototype.init___Lco_ledger_wallet_web_ethereum_controllers_WindowController = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2: 0
}, false, "co.ledger.wallet.web.ethereum.controllers.WindowController$$anonfun$2", {
  Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$2;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
}
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4.prototype = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4.prototype;
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4.prototype.apply__O__O = (function(v1) {
  this.apply__Z__V($uZ(v1))
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4.prototype.apply__Z__V = (function(enable) {
  this.$$outer$2.isUiEnabled$1 = enable;
  $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(0.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
    return (function() {
      arg$outer.$$outer$2.co$ledger$wallet$web$ethereum$controllers$WindowController$$$scope$f.$parent.$apply()
    })
  })(this)))
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4.prototype.init___Lco_ledger_wallet_web_ethereum_controllers_WindowController = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
var $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4: 0
}, false, "co.ledger.wallet.web.ethereum.controllers.WindowController$$anonfun$4", {
  Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$4;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1() {
  $c_sr_AbstractFunction5.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1.prototype = new $h_sr_AbstractFunction5();
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1.prototype.apply__sjs_js_Dynamic__Lco_ledger_wallet_web_ethereum_services_WindowService__Lbiz_enef_angulate_Scope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_JQLite__sjs_js_Dynamic = (function(scope, x$macro$13, x$macro$14, x$macro$15, x$macro$16) {
  var ctrl = new $c_Lco_ledger_wallet_web_ethereum_controllers_WindowController().init___Lco_ledger_wallet_web_ethereum_services_WindowService__Lbiz_enef_angulate_Scope__Lbiz_enef_angulate_core_JQLite__Lbiz_enef_angulate_core_JQLite(x$macro$13, x$macro$14, x$macro$15, x$macro$16);
  $g.Object.defineProperty(scope, "showNavigationBar", {
    "get": (function(ctrl$1) {
      return (function() {
        return ctrl$1.showNavigationBar$1
      })
    })(ctrl),
    "set": (function(ctrl$1$1) {
      return (function(v$2) {
        var v = $uZ(v$2);
        ctrl$1$1.showNavigationBar$1 = v
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "isUiEnabled", {
    "get": (function(ctrl$1$2) {
      return (function() {
        return ctrl$1$2.isUiEnabled$1
      })
    })(ctrl),
    "set": (function(ctrl$1$3) {
      return (function(v$2$1) {
        var v$1 = $uZ(v$2$1);
        ctrl$1$3.isUiEnabled$1 = v$1
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "refresh", {
    "value": (function(ctrl$1$4) {
      return (function() {
        ctrl$1$4.refresh__V()
      })
    })(ctrl)
...
var $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.controllers.WindowController$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1: 1,
...
$c_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_controllers_WindowController$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1() {
  $c_sr_AbstractFunction6.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1.prototype = new $h_sr_AbstractFunction6();
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1.prototype.apply__sjs_js_Dynamic__Lco_ledger_wallet_web_ethereum_services_WindowService__Lbiz_enef_angulate_Scope__sjs_js_Dynamic__Lbiz_enef_angulate_core_Location__sjs_js_Dictionary__sjs_js_Dynamic = (function(scope, x$macro$8, x$macro$9, x$macro$10, x$macro$11, x$macro$12) {
  var ctrl = new $c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController().init___Lco_ledger_wallet_web_ethereum_services_WindowService__Lbiz_enef_angulate_Scope__sjs_js_Dynamic__Lbiz_enef_angulate_core_Location__sjs_js_Dictionary(x$macro$8, x$macro$9, x$macro$10, x$macro$11, x$macro$12);
  $g.Object.defineProperty(scope, "windowService", {
    "get": (function(ctrl$1) {
      return (function() {
        return ctrl$1.windowService$1
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "$scope", {
    "get": (function(ctrl$1$1) {
      return (function() {
        return ctrl$1$1.$$scope$1
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "download", {
    "value": (function(ctrl$1$2) {
      return (function() {
        ctrl$1$2.download__V()
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "continue", {
    "value": (function(ctrl$1$3) {
      return (function() {
        return (void 0)
      })
    })(ctrl)
  });
  $g.Object.defineProperty(scope, "openHelpCenter", {
    "value": (function(ctrl$1$4) {
      return (function() {
        ctrl$1$4.openHelpCenter__V()
      })
    })(ctrl)
  });
  return scope
});
var $d_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.controllers.onboarding.LedgerLiveController$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1: 1,
...
$c_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_controllers_onboarding_LedgerLiveController$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1() {
  $c_sr_AbstractFunction2.call(this)
}
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1.prototype = new $h_sr_AbstractFunction2();
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1.prototype = $c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1.prototype.init___ = (function() {
  return this
});
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1.prototype.apply__sjs_js_Dynamic__Lbiz_enef_angulate_core_QService__sjs_js_Function = (function($$translate, $$q) {
  return (function($$translate$1) {
    return (function(date$2, format$2) {
      var format = $as_T(format$2);
      var i18nKey = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["dates.", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([format]));
      var i18nFormat = $as_T($$translate$1.instant(i18nKey));
      return $as_T((0, $g.moment)($uD(date$2.getTime())).format(((i18nKey === i18nFormat) ? format : i18nFormat)))
    })
  })($$translate)
});
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1.prototype.apply__O__O__O = (function(v1, v2) {
  return this.apply__sjs_js_Dynamic__Lbiz_enef_angulate_core_QService__sjs_js_Function(v1, v2)
});
var $d_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1: 0
}, false, "co.ledger.wallet.web.ethereum.filters.DateFormatFilter$$anonfun$init$1", {
  Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1: 1,
  sr_AbstractFunction2: 1,
  O: 1,
  F2: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_filters_DateFormatFilter$$anonfun$init$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry() {
  $c_O.call(this);
  this.code$1 = null;
  this.name$1 = null;
  this.keys$1 = null
}
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype = new $h_O();
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype = $c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype;
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.productPrefix__T = (function() {
  return "I18nLanguageEntry"
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.productArity__I = (function() {
  return 3
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(x$1)) {
    var I18nLanguageEntry$1 = $as_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(x$1);
    return (((this.code$1 === I18nLanguageEntry$1.code$1) && (this.name$1 === I18nLanguageEntry$1.name$1)) && (this.keys$1 === I18nLanguageEntry$1.keys$1))
  } else {
    return false
  }
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.code$1;
      break
...
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.init___T__T__T = (function(code, name, keys) {
  this.code$1 = code;
  this.name$1 = name;
  this.keys$1 = keys;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry)))
}
function $as_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(obj) {
  return (($is_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "co.ledger.wallet.web.ethereum.i18n.I18nLanguagesManifest$I18nLanguageEntry"))
}
function $isArrayOf_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry)))
}
function $asArrayOf_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(obj, depth) {
  return (($isArrayOf_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lco.ledger.wallet.web.ethereum.i18n.I18nLanguagesManifest$I18nLanguageEntry;", depth))
}
var $d_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry: 0
}, false, "co.ledger.wallet.web.ethereum.i18n.I18nLanguagesManifest$I18nLanguageEntry", {
  Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_i18n_I18nLanguagesManifest$I18nLanguageEntry;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null;
  this.start$1$2 = $m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong()
}
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1.prototype = new $h_sr_AbstractFunction1();
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1.prototype = $c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1.prototype.init___Lco_ledger_wallet_web_ethereum_services_WindowService__J = (function($$outer, start$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  this.start$1$2 = start$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1.prototype.apply__O__O = (function(v1) {
  return this.apply__s_util_Try__sjs_js_timers_SetTimeoutHandle($as_s_util_Try(v1))
});
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1.prototype.apply__s_util_Try__sjs_js_timers_SetTimeoutHandle = (function(x0$1) {
  var now = new $c_ju_Date().init___().getTime__J();
  return $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(new $c_sjsr_RuntimeLong().init___I__I(1000, 0).$$plus__sjsr_RuntimeLong__sjsr_RuntimeLong(now.$$minus__sjsr_RuntimeLong__sjsr_RuntimeLong(this.start$1$2).$$percent__sjsr_RuntimeLong__sjsr_RuntimeLong(new $c_sjsr_RuntimeLong().init___I__I(1000, 0))).toDouble__D(), new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
    return (function() {
      arg$outer.$$outer$2.co$ledger$wallet$web$ethereum$services$WindowService$$$undrefreshing$1 = false
    })
  })(this)))
});
var $d_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1: 0
}, false, "co.ledger.wallet.web.ethereum.services.WindowService$$anonfun$notifyRefresh$1", {
  Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_services_WindowService$$anonfun$notifyRefresh$1;
/** @constructor */
...
$c_s_concurrent_duration_Duration$Infinite.prototype.toMillis__J = (function() {
  this.fail__p2__T__sr_Nothing$("toMillis")
});
...
$c_s_concurrent_duration_FiniteDuration.prototype.toMillis__J = (function() {
  return this.unit$2.toMillis__J__J(this.length$2)
});
...
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1() {
  $c_sr_AbstractFunction0$mcZ$sp.call(this);
  this.currentInstance$1$3 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1.prototype = new $h_sr_AbstractFunction0$mcZ$sp();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef = (function($$outer, currentInstance$1) {
  this.currentInstance$1$3 = currentInstance$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1.prototype.apply$mcZ$sp__Z = (function() {
  var this$1 = $m_s_Option$().apply__O__s_Option($as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.currentInstance$1$3.elem$1));
  if ((!this$1.isEmpty__Z())) {
    var arg1 = this$1.get__O();
    var x$1 = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg1);
    return (x$1.$$undmode$1 === $m_Lco_ledger_wallet_web_ethereum_components_SnackBar$().SuccessMode$1)
  } else {
    return false
  }
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1.prototype.apply__O = (function() {
  return this.apply$mcZ$sp__Z()
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$1", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$1;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2() {
  $c_sr_AbstractFunction0$mcZ$sp.call(this);
  this.currentInstance$1$3 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2.prototype = new $h_sr_AbstractFunction0$mcZ$sp();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef = (function($$outer, currentInstance$1) {
  this.currentInstance$1$3 = currentInstance$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2.prototype.apply$mcZ$sp__Z = (function() {
  var this$1 = $m_s_Option$().apply__O__s_Option($as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.currentInstance$1$3.elem$1));
  if ((!this$1.isEmpty__Z())) {
    var arg1 = this$1.get__O();
    var x$2 = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg1);
    return (x$2.$$undmode$1 === $m_Lco_ledger_wallet_web_ethereum_components_SnackBar$().ErrorMode$1)
  } else {
    return false
  }
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2.prototype.apply__O = (function() {
  return this.apply$mcZ$sp__Z()
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$2", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2: 1,
  sr_AbstractFunction0$mcZ$sp: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$2;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3() {
  $c_sr_AbstractFunction0$mcZ$sp.call(this);
  this.currentInstance$1$3 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3.prototype = new $h_sr_AbstractFunction0$mcZ$sp();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef = (function($$outer, currentInstance$1) {
  this.currentInstance$1$3 = currentInstance$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3.prototype.apply$mcZ$sp__Z = (function() {
  var this$1 = $m_s_Option$().apply__O__s_Option($as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.currentInstance$1$3.elem$1));
  if ((!this$1.isEmpty__Z())) {
    var arg1 = this$1.get__O();
    var x$3 = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg1);
    return (x$3.$$undmode$1 === $m_Lco_ledger_wallet_web_ethereum_components_SnackBar$().NeutralMode$1)
  } else {
    return false
  }
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3.prototype.apply__O = (function() {
  return this.apply$mcZ$sp__Z()
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$3", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3: 1,
  sr_AbstractFunction0$mcZ$sp: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$3;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4() {
  $c_sr_AbstractFunction0$mcV$sp.call(this);
  this.currentInstance$1$f = null;
  this.element$1$3 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4.prototype = new $h_sr_AbstractFunction0$mcV$sp();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4.prototype.apply$mcV$sp__V = (function() {
  var jsx$2 = this.element$1$3;
  var jsx$1 = $m_sjs_js_Dictionary$();
  var y = (-$uD(this.element$1$3.outerHeight(false)));
  jsx$2.animate(jsx$1.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("bottom", y)])), 400, "default", (function(arg$outer) {
    return (function() {
      arg$outer.currentInstance$1$f.elem$1 = null
    })
  })(this))
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar__sr_ObjectRef__Lorg_scalajs_jquery_JQuery = (function($$outer, currentInstance$1, element$1) {
  this.currentInstance$1$f = currentInstance$1;
  this.element$1$3 = element$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4.prototype.apply__O = (function() {
  this.apply$mcV$sp__V()
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$4", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$4;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3() {
  $c_sr_AbstractFunction0$mcV$sp.call(this);
  this.$$outer$3 = null;
  this.timeout$1$f = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3.prototype = new $h_sr_AbstractFunction0$mcV$sp();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3.prototype.apply$mcV$sp__V = (function() {
  this.$$outer$3.scope$1$f.$digest();
  var jsx$1 = this.$$outer$3.element$1$f;
  var value = (-$uD(this.$$outer$3.element$1$f.outerHeight(false)));
  jsx$1.css("bottom", value);
  $m_Lco_ledger_wallet_web_ethereum_core_utils_JQueryHelper$().injectCustomEasings__V();
  this.$$outer$3.element$1$f.animate($m_sjs_js_Dictionary$().apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O("bottom", 0)])), 400, "default", (function(f) {
    return (function() {
      return f.apply__O()
    })
  })(new $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2().init___Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3(this)))
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9__sr_ObjectRef = (function($$outer, timeout$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
  };
  this.timeout$1$f = timeout$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3.prototype.apply__O = (function() {
  this.apply$mcV$sp__V()
});
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$9$$anonfun$apply$3", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3: 1,
  sr_AbstractFunction0$mcV$sp: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2() {
  $c_sr_AbstractFunction0$mcV$sp.call(this);
  this.$$outer$3 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2.prototype = new $h_sr_AbstractFunction0$mcV$sp();
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2.prototype = $c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2.prototype.apply$mcV$sp__V = (function() {
  if (($as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.$$outer$3.$$outer$3.currentInstance$1$f.elem$1) !== null)) {
    var jsx$2 = this.$$outer$3.timeout$1$f;
    var jsx$1 = $m_sjs_js_timers_package$();
    var this$1 = $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(this.$$outer$3.$$outer$3.currentInstance$1$f.elem$1);
    jsx$2.elem$1 = jsx$1.setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(this$1.$$unddelay$1.toMillis__J().toDouble__D(), new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
      return (function() {
        if (($as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg$outer.$$outer$3.$$outer$3.currentInstance$1$f.elem$1) !== null)) {
          $as_Lco_ledger_wallet_web_ethereum_components_SnackBar$SnackBarInstance(arg$outer.$$outer$3.$$outer$3.currentInstance$1$f.elem$1).dismissHandler$1.apply$mcV$sp__V()
        }
      })
    })(this)))
  }
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2.prototype.apply__O = (function() {
  this.apply$mcV$sp__V()
});
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2.prototype.init___Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
...
var $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2: 0
}, false, "co.ledger.wallet.web.ethereum.components.SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2", {
  Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2: 1,
  sr_AbstractFunction0$mcV$sp: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_SnackBar$$anonfun$controller$9$$anonfun$apply$3$$anonfun$apply$mcV$sp$2;
/** @constructor */
function $c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1() {
  $c_sr_AbstractFunction0$mcZ$sp.call(this);
  this.$$outer$3 = null;
  this.scope$1$3 = null;
  this.attrs$1$3 = null
}
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1.prototype = new $h_sr_AbstractFunction0$mcZ$sp();
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1.prototype.constructor = $c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1;
/** @constructor */
function $h_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1() {
  /*<skip>*/
}
$h_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1.prototype = $c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1.prototype;
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1.prototype.init___Lco_ledger_wallet_web_ethereum_components_Spinner__Lco_ledger_wallet_web_ethereum_components_Spinner$SpinnerScope__Lbiz_enef_angulate_core_Attributes = (function($$outer, scope$1, attrs$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
  };
  this.scope$1$3 = scope$1;
  this.attrs$1$3 = attrs$1;
  return this
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1.prototype.apply$mcZ$sp__Z = (function() {
  var v = this.attrs$1$3.ngShow;
  if ((v === (void 0))) {
    var v$1 = this.attrs$1$3.ngHide;
    var result = (v$1 === (void 0))
  } else {
    var result = false
  };
  var v$2 = this.attrs$1$3.ngShow;
  if ((!(v$2 === (void 0)))) {
    if (result) {
      result = true
    } else {
      var jsx$4 = this.$$outer$3.co$ledger$wallet$web$ethereum$components$Spinner$$$parse$f;
      var value = this.attrs$1$3.ngShow;
      if ((value === (void 0))) {
        var jsx$3 = (void 0)
      } else {
        var value$1 = $as_T(value);
      ...
      var jsx$2 = jsx$4(jsx$3);
      var jsx$1 = jsx$2(this.scope$1$3);
      result = $uZ(jsx$1)
    }
  };
  var v$3 = this.attrs$1$3.ngHide;
  if ((!(v$3 === (void 0)))) {
    if (result) {
      result = true
    } else {
      var jsx$8 = this.$$outer$3.co$ledger$wallet$web$ethereum$components$Spinner$$$parse$f;
      var value$2 = this.attrs$1$3.ngHide;
      if ((value$2 === (void 0))) {
        var jsx$7 = (void 0)
      } else {
        var value$3 = $as_T(value$2);
        var jsx$7 = value$3
      };
      var jsx$6 = jsx$8(jsx$7);
      var jsx$5 = jsx$6(this.scope$1$3);
      result = (!$uZ(jsx$5))
    }
  };
  return result
});
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1.prototype.apply__O = (function() {
  return this.apply$mcZ$sp__Z()
});
var $d_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1 = new $TypeData().initClass({
  Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1: 0
}, false, "co.ledger.wallet.web.ethereum.components.Spinner$$anonfun$1", {
  Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1: 1,
  sr_AbstractFunction0$mcZ$sp: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
...
$c_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1.prototype.$classData = $d_Lco_ledger_wallet_web_ethereum_components_Spinner$$anonfun$1;
/** @constructor */
...
//# sourceMappingURL=ledger-wallet-ethereum-chrome-fastopt.js.map
