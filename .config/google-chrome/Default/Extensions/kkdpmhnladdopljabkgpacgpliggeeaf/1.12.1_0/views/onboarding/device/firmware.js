...
window.JST["onboarding/device/firmware"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(t('onboarding.device.firmware.new_firmware_available')));
    
      __out.push('</br>');
    
      __out.push(__sanitize(t('onboarding.device.firmware.new_firmware_available_2')));
    
      __out.push('</div>\n    <div class="medium-indication">');
    
      __out.push(__sanitize(t('onboarding.device.firmware.indications')));
      ...
      __out.push(__sanitize(t('onboarding.device.firmware.open_manager')));
