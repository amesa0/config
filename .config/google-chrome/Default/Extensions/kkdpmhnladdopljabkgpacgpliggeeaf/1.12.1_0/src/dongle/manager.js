(function() {
  ...
  this.ledger.dongle.Manager = (function(_super) {
    ...
    function Manager(app) {
      ...
      this._factoryDongleOSHIDLedgerBlue = new ChromeapiPlugupCardTerminalFactory(0x0000, ledger.dongle.usagePage, true, 0x2c97);
      this._factoryDongleOSHIDLedgerNanoS = new ChromeapiPlugupCardTerminalFactory(0x0001, ledger.dongle.usagePage, true, 0x2c97);
      this._isPaused = true;
    }
        ...
        return function(_arg) {
          ...
          return terminal.getCard_async().then(function(card) {
            if (device.vendorId === 0x2c97) {
              return new BTChip(card).getWalletPublicKey_async("0'/0xb11e'").then(function() {
