(function() {
  ...
  this.declareRoutes = function(route, app) {
    ...
    route('/onboarding/device/chains/btg', function(params) {
      return app.navigate(ONBOARDING_LAYOUT, OnboardingDeviceChainsBtgViewController);
    });
    ...
    route('/onboarding/device/firmware', function(param) {
      return app.navigate(ONBOARDING_LAYOUT, OnboardingDeviceFirmwareViewController);
    });
    route('/onboarding/device/continue', function(param) {
      return ledger.app.onDongleIsUnlocked(ledger.app.dongle, true);
    });
    ...
    route('/onboarding/live/go', function(params) {
      return app.navigate(ONBOARDING_LAYOUT, OnboardingLiveGoViewController);
    });
    ...
    route('/wallet/receive/index:?params:', function(params) {
      ...
      if (!ledger.app.dongle.getFirmwareInformation().hasVerifyAddressOnScreen() || (ledger.app.dongle.getFirmwareInformation().getIntFirmwareVersion() < 0x30010109 && ledger.config.network.handleSegwit)) {
        ...
        dialog = new WalletReceiveEnforceIndexDialogViewController(params["?params"] || {});
      }
      return dialog.show();
    });
