(function() {
  ...
  this.WalletSettingsIndexDialogViewController = (function(_super) {
    ...
    WalletSettingsIndexDialogViewController.prototype.initialize = function() {
      WalletSettingsIndexDialogViewController.__super__.initialize.apply(this, arguments);
      this.hardware = ledger.app.dongle.getIntFirmwareVersion() < 0x30010101;
      return console.log("test is)", this.hardware);
    };
