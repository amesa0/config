(function() {
  ...
  this.WalletSendCpfpDialogViewController = (function(_super) {
    ...
    WalletSendCpfpDialogViewController.prototype.initialize = function() {
      ...
      this.feesPerByte = ledger.Amount.fromSatoshi(parseInt(ledger.tasks.FeesComputationTask.instance.getFeesForNumberOfBlocks(1) / 1000));
    ...
    WalletSendCpfpDialogViewController.prototype.onAfterRender = function() {
      ...
      return this.view.feesPerByte.on('keyup', _.debounce(((function(_this) {
        return function() {
          _this.feesPerByte = ledger.Amount.fromSatoshi(parseInt(_this.view.feesPerByte.val() || 0));
          return _this._checkFees();
        };
      })(this)), 50));
    };
    ...
    WalletSendCpfpDialogViewController.prototype._checkFees = function() {
      ...
      return ledger.bitcoin.cpfp.createTransaction(this.account, this.operation.get("hash"), ledger.Amount.fromSatoshi(this.feesPerByte)).then((function(_this) {
        return function(transaction) {
          ...
          _this.feesPerByte = _this.fees.add(_this.transaction.unconfirmed.fees).divide(_this.transaction.size);
          if (_this.feesPerByte.toSatoshiNumber() <= _this.transaction.unconfirmed.fees.divide(_this.transaction.unconfirmed.size).toSatoshiNumber()) {
        ...
        return function(err) {
          ...
          _this.view.feesPerByte.addClass('red');
          _this.view.check.text(err.localizedMessage());
          _this.view.check.addClass('red');
          _this.fees = _this.feesPerByte.multiply(_this.transaction.size);
          _this.countervalue = ledger.converters.satoshiToCurrencyFormatted(_this.fees);
          return _this._updateTotalLabel(_this.fees, _this.countervalue);
        };
      })(this));
