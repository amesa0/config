(function() {
  ...
  this.WalletSendIndexDialogViewController = (function(_super) {
    ...
    WalletSendIndexDialogViewController.prototype.openCashConverter = function() {
      return window.open("https\://cashaddr.bitcoincash.org/");
    };
    ...
    WalletSendIndexDialogViewController.prototype.send = function() {
      ...
      if (nextError != null) {
        ...
        return this.view.errorContainer.html(nextError);
      } else {
        this.view.errorContainer.hide();
    ...
    WalletSendIndexDialogViewController.prototype.openSensitive = function() {
    ...
    WalletSendIndexDialogViewController.prototype._nextFormError = function() {
      ...
      } else if (ledger.config.network.ticker === 'abc' && this._receiverBitcoinAddress().startsWith("bitcoincash")) {
