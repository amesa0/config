(function() {
  ...
  this.ledger.utils.Logger = (function() {
    ...
    Logger.downloadLogsToZip = function() {
      return ledger.managers.permissions.request({
        permissions: ["fileSystem.write"]
      }, (function(_this) {
        return function(granted) {
          return _this.exportLogsToZip(function(data) {
              ...
              return function(file) {
                return file.createWriter(function(writer) {
                  writer.onwriteend = function(e) {
                    return console.log("logs saved");
                  };
                  return writer.write(data.zip);
                });
              };
            })(this));
          });
